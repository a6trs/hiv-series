...
arguments);this._super=c;return d}}(q,n[q]),Object.defineProperty(f,q,h)):t?(h.value=n[q],Object.defineProperty(f,q,h)):f[q]=n[q];if(t){var v,x;if(this.__getters__&&this.__getters__[q]){var t=this.__getters__[q],w;for(w in this.__setters__)if(this.__setters__[w]==t){x=w;break}cc.defineGetterSetter(f,t,n[q],n[x]?n[x]:f[x],q,x)}if(this.__setters__&&this.__setters__[q]){t=this.__setters__[q];for(w in this.__getters__)if(this.__getters__[w]==t){v=w;break}cc.defineGetterSetter(f,t,n[v]?n[v]:f[v],n[q],
...
texCoords:cc.__t(cc.v2fzero())},{vertices:h,colors:b,texCoords:cc.__t(cc.v2fzero())},{vertices:k,colors:b,texCoords:cc.__t(cc.v2fzero())},t,r.length*q));for(f=0;f<m;f++){u=(f+1)%m;g=cc.__v2f(a[f]);h=cc.__v2f(a[u]);k=e[f].n;var v=e[f].offset,x=e[u].offset,u=n?cc.v2fsub(g,cc.v2fmult(v,c)):cc.v2fsub(g,cc.v2fmult(v,.5)),w=n?cc.v2fsub(h,cc.v2fmult(x,c)):cc.v2fsub(h,cc.v2fmult(x,.5));g=n?cc.v2fadd(g,cc.v2fmult(v,c)):cc.v2fadd(g,cc.v2fmult(v,.5));h=n?cc.v2fadd(h,cc.v2fmult(x,c)):cc.v2fadd(h,cc.v2fmult(x,
...
acg.ext.speechbub=function(a,b,c,d,e,f,g,h,k){k=k||acg.colour.BLACK;k[0]&&(k=acg.colour(k[0],k[1],k[2]));var m=cc.DrawNode.create();m.setCascadeOpacityEnabled(!0);a=cc.LabelTTF.create(a,"Arial",acg.ext.speechbub_fontsize);a.setAnchorPoint(cc.p(0,0));a.setPosition(cc.p(0,0));a.setColor(k);m.addChild(a);var n=a.getContentSize();a=n.width+2*acg.ext.speechbub_horpadding;n=n.height;m.drawSegment(cc.p(a*d,n*e),cc.p(a*f,n*g),acg.ext.speechbub_borderw/2,k);m.setContentSize(cc.size(a,n));acg.init_matter(m,
{x:b,y:c,ax:d,ay:e,opacity:1},h);return m._acg_id};cc=cc||{};acg=acg||{};acg.ext=acg.ext||{};acg.ext._cp_layer=null;acg.ext._cp_ctrls=[];acg.ext._cp_ctrls_showed=!1;acg.ext._cp_swiping=!1;acg.ext._cp_swipemax=25;acg.ext._cp_shouldbepaused=null;acg.ext._cp_colourdisp_tag=12138;acg.ext._cp_danmakutypes=["danmaku-sliding.png","danmaku-stktop.png","danmaku-stkbottom.png"];acg.ext._cp_textcolours="#ffffff #ff0000 #ffff00 #00ff00 #2299ff #dd00dd #2299ff #22ff00 #000088 #ffbb00 #9900bb #55dddd #887700".split(" ");acg.ext._cp_dominput=null;
acg._init_callbacks.push(function(){var a=document.createElement("input");document.body.appendChild(a);var b=document.getElementById("Cocos2dGameContainer");a.style.display="none";a.style.position="absolute";a.type="text";a.placeholder="Press Enter to send";a.onkeyup=function(a){13===a.keyCode&&(callback(acg.time,cmttyp_menu.selectedIndex(),acg.ext._cp_textcolours[cmtcl_menu.selectedIndex()],a.target.value),a.target.value="",di.hideInput())};acg.ext._cp_dominput=a;var c=window.onresize;window.onresize=
function(){c&&c(arguments);a.style.top=b.offsetTop+.05*b.clientHeight+"px";a.style.left=b.offsetLeft+.06*b.clientWidth+"px";a.style.width=.88*b.clientWidth+"px";a.style["font-size"]=16/acg.height*b.clientHeight+"px"};window.onresize()});acg.ext.is_touch_in_content=function(a,b){var c=b.getCurrentTarget().convertTouchToNodeSpace(a),d=b.getCurrentTarget().getContentSize();return!(0>c.x||c.x>d.width||0>c.y||c.y>d.height)};
acg.ext.touch_swiping=function(a){return 100<cc.pDistanceSQ(a.getStartLocation(),a.getLocation())};
...
acg.ext.cp_danmakuipt=function(a){a=cc.DrawNode.create();var b=.88*acg.width;a.setAnchorPoint(cc.p(.5,1));var c=[];acg.ext.pushArcVerts(c,cc.p(4,4),4,-Math.PI/2,-Math.PI);acg.ext.pushArcVerts(c,cc.p(4,20),4,Math.PI,Math.PI/2);acg.ext.pushArcVerts(c,cc.p(b-4,20),4,Math.PI/2,0);acg.ext.pushArcVerts(c,cc.p(b-4,4),4,0,-Math.PI/2);a.drawPoly_(c,cc.color.WHITE,1,cc.color.BLACK);a.setContentSize(cc.size(b,24));var d=acg.ext._cp_danmakutypes.length,e=acg.ext.toggle_menu(d,function(a){console.log(a);for(var b=
0;b<d;b++)e.getChildByTag(b).setVisible(b===a)});e.setAnchorPoint(cc.p(0,1));e.setPosition(cc.p(0,-5));e.setContentSize(cc.size(60,45));e.setCascadeOpacityEnabled(!0);a.setCascadeOpacityEnabled(!0);a.addChild(e);for(b=0;b<d;b++)c=cc.Sprite.create(acg.ext._res_path+"/"+acg.ext._cp_danmakutypes[b]),c.setAnchorPoint(cc.p(0,0)),c.setVisible(0===b),c.setScale(.5),e.addChild(c,0,b);var f=acg.ext.toggle_menu(acg.ext._cp_textcolours.length,function(a){f.getChildByTag(acg.ext._cp_colourdisp_tag).setColor(cc.color(acg.ext._cp_textcolours[a]))});
f.setAnchorPoint(cc.p(0,1));f.setPosition(cc.p(75,-6));f.setContentSize(cc.size(60,45));f.setCascadeOpacityEnabled(!0);a.addChild(f);b=cc.LayerColor.create(cc.color(0,0,0));b.setContentSize(cc.size(54,41.5));b.setPosition(cc.p(0,3));f.addChild(b,0);b=cc.LayerColor.create(cc.color(acg.ext._cp_textcolours[0]));b.setContentSize(cc.size(46,34));b.setPosition(cc.p(4,7));f.addChild(b,1,acg.ext._cp_colourdisp_tag);cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,
b){var c=acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(a,b);c&&(acg.ext._cp_dominput.style.display="",setTimeout(function(){acg.ext._cp_dominput.focus()},10));return c}},a);a.hideInput=function(){acg.ext._cp_dominput.style.display="none"};return a};
...
acg.ext.stickman=function(a,b,c,d){d=d||acg.colour.BLACK;d[0]&&(d=acg.colour(d[0],d[1],d[2]));var e=acg.ext.sm_headsize*acg.height,f=acg.ext.sm_bodylen*acg.height,g=acg.ext.sm_leglen*acg.height,h=acg.ext.sm_armlen*acg.height,k=acg.ext.sm_armpos*acg.height;a.width=e/acg.width;a.height=acg.ext.sm_headsize+acg.ext.sm_bodylen+acg.ext.sm_leglen;var m=a.height*acg.height,n=cc.Layer.create();acg.init_matter(n,a,b);a=cc.DrawNode.create();a.drawDot(cc.p(0,e/2),e/2,d);acg.init_matter(a,{x:.5,y:(g+f)/m,ax:.5,
ay:0,width:1,height:e/m},c.head,n);b=cc.DrawNode.create();b.drawSegment(cc.p(e/2,0),cc.p(e/2,f),acg.ext.sm_strokew,d);b.setPosition(cc.p(0,g));n.addChild(b);e=acg.ext.stickman_oneleg(g,d);acg.init_matter(e,{x:.5,y:g/m,ax:0,ay:0},c.leg1,n);acg.init_matter(e._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["leg1-shin"],e);f=acg.ext.stickman_oneleg(g,d);acg.init_matter(f,{x:.5,y:g/m,ax:0,ay:0},c.leg2,n);acg.init_matter(f._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["leg2-shin"],f);b=acg.ext.stickman_oneleg(h,d);acg.init_matter(b,
{x:.5,y:(k+g)/m,ax:0,ay:0},c.arm1,n);acg.init_matter(b._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["arm1-shin"],b);d=acg.ext.stickman_oneleg(h,d);acg.init_matter(d,{x:.5,y:(k+g)/m,ax:0,ay:0},c.arm2,n);acg.init_matter(d._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["arm2-shin"],d);return[n._acg_id,a._acg_id,e._acg_id,e._acg_sm_shin._acg_id,f._acg_id,f._acg_sm_shin._acg_id,b._acg_id,b._acg_sm_shin._acg_id,d._acg_id,d._acg_sm_shin._acg_id]};acg=acg||{};acg.ext=acg.ext||{};acg.ext._233_recs=[];acg.ext._233_fontname="Arial";acg.ext._233_fontsize=26;acg.ext._233_lineh=32;acg.ext._233_layer=null;acg.ext._233_firstresume=!0;acg.ext._233_onpause_reg=function(){acg.ext._233_layer.getChildren().forEach(function(a){a.pause()})};
