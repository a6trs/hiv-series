...
acg.ext._233_addSticky=function(a,b,c,d,e,f){f=f||acg.colour.WHITE;c=cc.LabelTTF.create(c,acg.ext._233_fontname,acg.ext._233_fontsize);c.setLocalZOrder(2333333);if(1===a)c.setAnchorPoint(cc.p(.5,1)),c.setNormalizedPosition(cc.p(.5,1-b*acg.ext._233_lineh/acg.width));else if(2===a)c.setAnchorPoint(cc.p(.5,0)),c.setNormalizedPosition(cc.p(.5,b*acg.ext._233_lineh/acg.width));else{console.log("acg.ext._233_addSticky: Invalid type T^T");return}c.setColor(f);c.setVisible(!1);c.runAction(cc.sequence(cc.delayTime(d),
