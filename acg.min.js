...
g.setAnchorPoint(cc.p(0,1));g.setPosition(cc.p(75,-6));g.setContentSize(cc.size(60,45));g.setCascadeOpacityEnabled(!0);b.addChild(g);c=cc.LayerColor.create(cc.color(0,0,0));c.setContentSize(cc.size(54,41.5));c.setPosition(cc.p(0,3));g.addChild(c,0);c=cc.LayerColor.create(cc.color(acg.ext._cp_textcolours[0]));c.setContentSize(cc.size(46,34));c.setPosition(cc.p(4,7));g.addChild(c,1,acg.ext._cp_colourdisp_tag);acg.ext._cp_cmt_callback=function(c){a(acg.time,f.selectedIndex(),acg.ext._cp_textcolours[g.selectedIndex()],
c.target.value);c.target.value="";b.hideInput()};cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){var c=acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(a,b);c&&(acg.ext._cp_dominput.style.display="",setTimeout(function(){acg.ext._cp_dominput.focus()},10));return c}},b);b.hideInput=function(){acg.ext._cp_dominput.style.display="none"};return b};
