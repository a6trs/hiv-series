...
(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw d;var m=c.modules||[],n=f.module,q=[];cc._renderType==cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var r=0,s=m.length;r<s;r++){var t=b._getJsListOfModule(n,m[r],e);t&&(q=q.concat(t))}q=q.concat(g);cc.loader.loadJsWithImg(q,function(c){if(c)throw c;b._prepared=!0;a&&a()})}))}};cc.game._initConfig();
...
var r=this._skewX||this._skewY;r||0===c&&0===e||(a+=n*d*g+-m*f*h,b+=q*d*g+k*f*h);var s=this._transform;s.a=n*g;s.b=q*g;s.c=-m*h;s.d=k*h;s.tx=a;s.ty=b;r&&(s=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(this._skewY)),c:Math.tan(cc.degreesToRadians(this._skewX)),d:1,tx:0,ty:0},s),0!==c||0!==e)&&(s=cc.affineTransformTranslate(s,d,f));this._additionalTransformDirty&&(s=cc.affineTransformConcat(s,this._additionalTransform),this._additionalTransformDirty=!1);this._transform=s;this._transformDirty=
...
n&&(n=99999999);var q=g*m*h,r=f*n*k;a.a=b+-c*n;a.b=b*m+-c;a.c=c+b*n;a.d=c*m+b;a.tx+=b*q+-c*r;a.ty+=c*q+b*r}if(1!==d||1!==e)a.a*=h,a.c*=h,a.b*=k,a.d*=k;a.tx+=b*-f*h+-c*g*k;a.ty-=c*-f*h+b*g*k;this._ignoreAnchorPointForPosition&&(a.tx+=f,a.ty+=g);this._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(a,this._additionalTransform),this._additionalTransformDirty=!1);this._transformDirty=!1}return this._transform};_p=null}else cc.assert(cc.isFunction(cc._tmp.WebGLCCNode),cc._LogInfos.MissingFile,
...
cc.audioEngine=cc.AudioEngineForSingle?new cc.AudioEngineForSingle:new cc.AudioEngine;cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()});cc._globalFontSize=cc.ITEM_SIZE;cc._globalFontName="Arial";cc._globalFontNameRelease=!1;
...
cc.MenuItem.prototype.activate.call(this))},selected:function(){if(this._enabled){cc.MenuItem.prototype.selected.call(this);var a=this.getActionByTag(cc.ZOOM_ACTION_TAG);a?this.stopAction(a):this._originalScale=this.scale;a=cc.scaleTo(.1,1.2*this._originalScale);a.setTag(cc.ZOOM_ACTION_TAG);this.runAction(a)}},unselected:function(){if(this._enabled){cc.MenuItem.prototype.unselected.call(this);this.stopActionByTag(cc.ZOOM_ACTION_TAG);var a=cc.scaleTo(.1,this._originalScale);a.setTag(cc.ZOOM_ACTION_TAG);
...
24),a.setHorizontalAlignment(b.halign||acg.ALIGN_CENTRE),a.setVerticalAlignment(b.valign||acg.ALIGN_CENTRE),a.setDimensions(b.size||cc.size(0,0)),a.setString(b.text||"WHAT DO I NEED TO SAY??"));a instanceof cc.Sprite?(a.setFlippedX(b.flipx||!1),a.setFlippedY(b.flipy||!1)):a instanceof cc.Layer&&(b.width=b.width||1,b.height=b.height||1,a.changeWidthAndHeight(b.width*c.width,b.height*c.height))};acg=acg||{};acg.ac=acg.ac||{};acg.init_matter=function(a,b,c){acg.apply_attr(a,b);c&&(a._acg_action=acg.ac.parse(c));a._acg_id=acg.matters.push(a)-1;a._acg_attr=b};acg.img=function(a,b,c){a=cc.Sprite.create(a);acg.init_matter(a,b,c);return a._acg_id};acg.text=function(a,b){var c=cc.LabelTTF.create();acg.init_matter(c,a,b);return c._acg_id};acg.rect=function(a,b){var c=cc.LayerColor.create();acg.init_matter(c,a,b);return c._acg_id};acg=acg||{};cc=cc||{};acg.bootstrap=function(a,b){cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.sys.isMobile?cc.view.setDesignResolutionSize(480,320,cc.ResolutionPolicy.FIXED_WIDTH):cc.view.setDesignResolutionSize(480,320,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.director.setDisplayStats(!0);cc.director.runScene(new cc.Scene)};cc.game.run(a);if(b)var c=setInterval(function(){cc.director&&cc.director.getRunningScene()&&(clearInterval(c),b())},300)};acg=acg||{};acg.EVENT_ENTER=0;acg.EVENT_LEAVE=1;acg._flow=[];acg._flow_tmp=[];acg._last_flow_idx=-1;acg.put=function(a,b){acg.matters[b]._acg_entertime=a;acg._flow_tmp.push({time:a,type:acg.EVENT_ENTER,id:b});acg._flow_tmp.push({time:a+acg.action_duration(b),type:acg.EVENT_LEAVE,id:b})};acg.sort=function(a){var b,c,d;for(b=0;b<a.length-1;b++)for(c=b+1;c<a.length;c++)a[b].time>a[c].time&&(d=a[b],a[b]=a[c],a[c]=d)};
acg.find=function(a,b){if(b<a[0].time)return-1;for(var c=0;c<a.length&&b>=a[c].time;)c++;for(c--;0<c&&a[c-1].time===a[c].time;)c--;return c};acg.tot_time=function(){var a=-1;acg._flow_tmp.forEach(function(b){b.time>a&&(a=b.time)});return a};
acg.commit=function(){acg._flow=[];acg.sort(acg._flow_tmp);for(var a=-1,b=0;b<acg._flow_tmp.length;b++){var c=acg._flow_tmp[b];.01>=Math.abs(c.time-a)?acg._flow[acg._flow.length-1].events.push(c):(acg._flow.push({time:c.time,events:[c]}),a=c.time)}acg._flow[-1]={present:[]};for(b=0;b<acg._flow.length;b++){var c=acg._flow[b],d=acg._flow[b-1].present.slice();c.events.forEach(function(a){if(a.type===acg.EVENT_LEAVE)for(var b=0;b<d.length;b++)d[b]===a.id&&(d[b]=-1);else d.push(a.id)});c.present=[];for(a=
0;a<d.length;a++)-1!==d[a]&&c.present.push(d[a]);acg._flow[b]=c}console.log()};acg.travel=function(a){var b=acg.find(acg._flow,acg.time);-1!==b&&acg._flow[b].present.forEach(function(a){acg.sweep(a);console.log("sweep: "+a)});b=acg.find(acg._flow,a);-1!==b&&acg._flow[b].present.forEach(function(a){acg.place(a)});acg._last_flow_idx=acg.find(acg._flow,a);acg.time=a;cc.director.getRunningScene().update=acg.update;cc.director.getRunningScene().scheduleUpdate()};
acg.update=function(a){acg.time+=a;a=acg.find(acg._flow,acg.time);acg._last_flow_idx!==a&&(acg._flow[a].events.forEach(function(a){a.type===acg.EVENT_LEAVE?(acg.sweep(a.id),console.log("flow-sweep: "+a.id)):(acg.place(a.id),console.log("flow-place: "+a.id))}),acg._last_flow_idx=a);acg._flow[a].present.forEach(function(a){a=acg.matters[a];a._acg_action.step(acg.time-a._acg_entertime-a._acg_action.getElapsed())})};
