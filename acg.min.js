(function(a){var b=function(){function a(b,d,e){if(void 0===d){if(0===b.length)return;d=0;e=b.length-1}var f=d,g=e,h=b[d+e>>1][0],k;do{for(;b[f][0]<h;)f++;for(;b[g][0]>h;)g--;f<=g&&(k=b[f],b[f]=b[g],b[g]=k,f++,g--)}while(f<=g);f<e&&a(b,f,e);g>d&&a(b,d,g)}function b(d,e,f,g,h,k){a(d);var v=[],x,w,y,B,z,A;for(x=0;x<d.length;x++){y=d[x];B=!1;w=Math.random()*(h-g)+g;z={type:k,time:y[0],duration:w,text:y[1],colour:y[2]};A=y[0]+w;f&&(z.duration=w,A=y[0]+.3*w);for(w=0;w<v.length;w++)if(v[w]<y[0]){z.line=
w;v[w]=A;B=!0;break}B||(z.line=v.length,v.push(A));e.push(z)}}var e=[[],[],[]],f=10,g=25,h=2,k=3;return{addComment:function(a,b,c,d){e[d].push([a,b,c])},reset:function(){e=[[],[],[]]},getOperations:function(){var a=[];b(e[0],a,!0,f,g,0);b(e[1],a,!1,h,k,1);b(e[2],a,!1,h,k,2);return a},setDurRange:function(a,b,c,d){a&&(f=a);b&&b>=a&&(g=b);c&&(h=c);d&&d>=c&&(k=d)},CMT_SLIDING:0,CMT_TOP_STICKY:1,CMT_BOTTOM_STICKY:2}}();a.js233=b})(this);var cc=cc||{};cc._tmp=cc._tmp||{};cc._LogInfos={};window._p;_p=window;_p.gl;_p.WebGLRenderingContext;_p.DeviceOrientationEvent;_p.DeviceMotionEvent;_p.AudioContext;_p.webkitAudioContext;_p.mozAudioContext;_p=Object.prototype;_p._super;_p.ctor;delete window._p;cc.newElement=function(a){return document.createElement(a)};cc._addEventListener=function(a,b,c,d){a.addEventListener(b,c,d)};cc._isNodeJs="undefined"!==typeof require&&require("fs");
...
c.BROWSER_TYPE_OPERA,c.BROWSER_TYPE_FIREFOX,c.BROWSER_TYPE_CHROME,c.BROWSER_TYPE_BAIDU_APP,c.BROWSER_TYPE_SAFARI,c.BROWSER_TYPE_UC,c.BROWSER_TYPE_QQ,c.BROWSER_TYPE_MOBILE_QQ,c.BROWSER_TYPE_IE],g=window,h=g.navigator,k=document.documentElement,n=h.userAgent.toLowerCase();c.isMobile=-1!=n.indexOf("mobile")||-1!=n.indexOf("android");c.platform=c.isMobile?c.MOBILE_BROWSER:c.DESKTOP_BROWSER;var m=h.language,m=(m=m?m:h.browserLanguage)?m.split("-")[0]:c.LANGUAGE_ENGLISH;c.language=m;var m=c.BROWSER_TYPE_UNKNOWN,
q=n.match(/micromessenger|qqbrowser|mqqbrowser|ucbrowser|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i)||n.match(/chrome|safari/i);q&&0<q.length&&(m=q[0].toLowerCase(),"micromessenger"==m?m=c.BROWSER_TYPE_WECHAT:"safari"===m&&n.match(/android.*applewebkit/)?m=c.BROWSER_TYPE_ANDROID:"trident"==m&&(m=c.BROWSER_TYPE_IE));c.browserType=m;m=n.match(/(iPad|iPhone|iPod)/i)?!0:!1;n=n.match(/android/i)||h.platform.match(/android/i)?!0:!1;q=c.OS_UNKNOWN;-1!=h.appVersion.indexOf("Win")?
q=c.OS_WINDOWS:m?q=c.OS_IOS:-1!=h.appVersion.indexOf("Mac")?q=c.OS_OSX:-1!=h.appVersion.indexOf("X11")?q=c.OS_UNIX:n?q=c.OS_ANDROID:-1!=h.appVersion.indexOf("Linux")&&(q=c.OS_LINUX);c.os=q;c._supportMultipleAudio=-1<f.indexOf(c.browserType);f=parseInt(a[b.renderMode]);n=cc._RENDER_TYPE_WEBGL;m=cc.newElement("Canvas");cc._supportRender=!0;d=!window.WebGLRenderingContext||-1==d.indexOf(c.browserType)||-1==e.indexOf(c.os);if(1===f||0===f&&d||"file://"==location.origin)n=cc._RENDER_TYPE_CANVAS;c._canUseCanvasNewBlendModes=
function(){var a=document.createElement("canvas");a.width=1;a.height=1;a=a.getContext("2d");a.fillStyle="#000";a.fillRect(0,0,1,1);a.globalCompositeOperation="multiply";var b=document.createElement("canvas");b.width=1;b.height=1;var c=b.getContext("2d");c.fillStyle="#fff";c.fillRect(0,0,1,1);a.drawImage(b,0,0,1,1);return 0===a.getImageData(0,0,1,1).data[0]};c._supportCanvasNewBlendModes=c._canUseCanvasNewBlendModes();n!=cc._RENDER_TYPE_WEBGL||g.WebGLRenderingContext&&cc.create3DContext(m,{stencil:!0,
preserveDrawingBuffer:!0})||(0==f?n=cc._RENDER_TYPE_CANVAS:cc._supportRender=!1);if(n==cc._RENDER_TYPE_CANVAS)try{m.getContext("2d")}catch(t){cc._supportRender=!1}cc._renderType=n;try{c._supportWebAudio=!!new (g.AudioContext||g.webkitAudioContext||g.mozAudioContext)}catch(r){c._supportWebAudio=!1}try{var u=c.localStorage=g.localStorage;u.setItem("storage","");u.removeItem("storage");u=null}catch(v){"SECURITY_ERR"!==v.name&&"QuotaExceededError"!==v.name||cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option"),
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,n=arguments.length;k<n;++k){var m=arguments[k],q;for(q in m){var t="function"===typeof m[q],r="function"===typeof e[q],u=a.test(m[q]);b&&t&&r&&u?(h.value=ClassManager.compileSuper(m[q],q,g),Object.defineProperty(f,q,h)):t&&r&&u?(h.value=function(a,b){return function(){var c=this._super;this._super=e[a];var d=b.apply(this,
arguments);this._super=c;return d}}(q,m[q]),Object.defineProperty(f,q,h)):t?(h.value=m[q],Object.defineProperty(f,q,h)):f[q]=m[q];if(t){var v,x;if(this.__getters__&&this.__getters__[q]){var t=this.__getters__[q],w;for(w in this.__setters__)if(this.__setters__[w]==t){x=w;break}cc.defineGetterSetter(f,t,m[q],m[x]?m[x]:f[x],q,x)}if(this.__setters__&&this.__setters__[q]){t=this.__setters__[q];for(w in this.__getters__)if(this.__getters__[w]==t){v=w;break}cc.defineGetterSetter(f,t,m[v]?m[v]:f[v],m[q],
v,q)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var b in a)f[b]=a[b]};return d}})();
cc.defineGetterSetter=function(a,b,c,d,e,f){if(a.__defineGetter__)c&&a.__defineGetter__(b,c),d&&a.__defineSetter__(b,d);else if(Object.defineProperty){var g={enumerable:!1,configurable:!0};c&&(g.get=c);d&&(g.set=d);Object.defineProperty(a,b,g)}else throw Error("browser does not support getters");if(!e&&!f)for(var g=null!=c,h=void 0!=d,k=Object.getOwnPropertyNames(a),n=0;n<k.length;n++){var m=k[n];if((a.__lookupGetter__?!a.__lookupGetter__(m):!Object.getOwnPropertyDescriptor(a,m))&&"function"===typeof a[m]){var q=
a[m];if(g&&q===c&&(e=m,!h||f))break;if(h&&q===d&&(f=m,!g||e))break}}a=a.constructor;e&&(a.__getters__||(a.__getters__={}),a.__getters__[e]=b);f&&(a.__setters__||(a.__setters__={}),a.__setters__[f]=b)};cc.clone=function(a){var b=a.constructor?new a.constructor:{},c;for(c in a){var d=a[c];b[c]="object"!=typeof d||!d||d instanceof cc.Node||d instanceof HTMLElement?d:cc.clone(d)}return b};cc.Point=function(a,b){this.x=a||0;this.y=b||0};
...
cc.arrayRemoveArray=function(a,b){for(var c=0,d=b.length;c<d;c++)cc.arrayRemoveObject(a,b[c])};cc.arrayAppendObjectsToIndex=function(a,b,c){a.splice.apply(a,[c,0].concat(b));return a};cc.copyArray=function(a){var b,c=a.length,d=Array(c);for(b=0;b<c;b+=1)d[b]=a[b];return d};
...
cc.BlendFunc=function(a,b){this.src=a;this.dst=b};cc.blendFuncDisable=function(){return new cc.BlendFunc(cc.ONE,cc.ZERO)};cc.hexToColor=function(a){a=a.replace(/^#?/,"0x");a=parseInt(a);return cc.color(a>>16,(a>>8)%256,a%256)};cc.colorToHex=function(a){var b=a.r.toString(16),c=a.g.toString(16),d=a.b.toString(16);return"#"+(16>a.r?"0"+b:b)+(16>a.g?"0"+c:c)+(16>a.b?"0"+d:d)};cc.TEXT_ALIGNMENT_LEFT=0;cc.TEXT_ALIGNMENT_CENTER=1;cc.TEXT_ALIGNMENT_RIGHT=2;cc.VERTICAL_TEXT_ALIGNMENT_TOP=0;
cc.VERTICAL_TEXT_ALIGNMENT_CENTER=1;cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM=2;
...
a.name="viewport";a.content="";b=cc.sys.isMobile&&cc.sys.browserType==cc.sys.BROWSER_TYPE_FIREFOX?{width:"device-width","initial-scale":"1.0"}:{width:"device-width","user-scalable":"no","maximum-scale":"1.0","initial-scale":"1.0"};cc.sys.isMobile&&(b["target-densitydpi"]=this._targetDensityDPI);d=c?c.content:"";for(var e in b)(new RegExp(e)).test(d)||(d+=","+e+"="+b[e]);""!=d&&(d=d.substr(1));a.content=d;c&&(c.content=d);document.head.appendChild(a)}},_setScaleXYForRenderTexture:function(){var a=
...
(function(){var a=cc.ContainerStrategy.extend({apply:function(a){this._setupContainer(a,a._frameSize.width,a._frameSize.height)}}),b=cc.ContainerStrategy.extend({apply:function(a,b){var c=a._frameSize.width,d=a._frameSize.height,e=cc.container.style,m=b.width,q=b.height,t=c/m,r=d/q,u,v;t<r?(u=c,v=q*t):(u=m*r,v=d);m=Math.round((c-u)/2);v=Math.round((d-v)/2);this._setupContainer(a,c-2*m,d-2*v);e.marginLeft=m+"px";e.marginRight=m+"px";e.marginTop=v+"px";e.marginBottom=v+"px"}});a.extend({preApply:function(a){this._super(a);
...
y:a.clientY}},getTouchesByEvent:function(a,b){for(var c=[],d=this._glView,e,f,g=this._preTouchPoint,h=a.changedTouches.length,k=0;k<h;k++)if(e=a.changedTouches[k]){var n;n=cc.sys.BROWSER_TYPE_FIREFOX===cc.sys.browserType?d.convertToLocationInView(e.pageX,e.pageY,b):d.convertToLocationInView(e.clientX,e.clientY,b);null!=e.identifier?(e=new cc.Touch(n.x,n.y,e.identifier),f=this.getPreTouch(e).getLocation(),e._setPrevPoint(f.x,f.y),this.setPreTouch(e)):(e=new cc.Touch(n.x,n.y),e._setPrevPoint(g.x,g.y));
...
b===cc.EventListener.ACCELERATION&&(c=new cc._EventListenerAcceleration(a.callback),delete a.callback);for(var d in a)c[d]=a[d];return c};
...
c.length,f=0;f<e;f++)d[f]=c[f];for(f=0;f<e;f++)d[f].callback.call(d[f].eventTarget,this);b&&(c.length=0)}}}};
...
this._rotationY=a;this._rotationRadiansX=.017453292519943295*this._rotationX;this._rotationRadiansY=.017453292519943295*this._rotationY;this.setNodeDirty()},getRotationX:function(){return this._rotationX},setRotationX:function(a){this._rotationX=a;this._rotationRadiansX=.017453292519943295*this._rotationX;this.setNodeDirty()},getRotationY:function(){return this._rotationY},setRotationY:function(a){this._rotationY=a;this._rotationRadiansY=.017453292519943295*this._rotationY;this.setNodeDirty()},getScale:function(){this._scaleX!==
this._scaleY&&cc.log(cc._LogInfos.Node_getScale);return this._scaleX},setScale:function(a,b){this._scaleX=a;this._scaleY=b||0===b?b:a;this.setNodeDirty()},getScaleX:function(){return this._scaleX},setScaleX:function(a){this._scaleX=a;this.setNodeDirty()},getScaleY:function(){return this._scaleY},setScaleY:function(a){this._scaleY=a;this.setNodeDirty()},setPosition:function(a,b){var c=this._position;void 0===b?(c.x=a.x,c.y=a.y):(c.x=a,c.y=b);this.setNodeDirty();this._usingNormalizedPosition=!1},setNormalizedPosition:function(a,
b){var c=this._normalizedPosition;void 0===b?(c.x=a.x,c.y=a.y):(c.x=a,c.y=b);this.setNodeDirty();this._normalizedPositionDirty=this._usingNormalizedPosition=!0},getPosition:function(){return cc.p(this._position)},getNormalizedPosition:function(){return cc.p(this._normalizedPosition)},getPositionX:function(){return this._position.x},setPositionX:function(a){this._position.x=a;this.setNodeDirty()},getPositionY:function(){return this._position.y},setPositionY:function(a){this._position.y=a;this.setNodeDirty()},
getNormalizedPositionX:function(){return this._normalizedPosition.x},setNormalizedPositionX:function(a){this._normalizedPosition.x=a;this.setNodeDirty()},getNormalizedPositionY:function(){return this._normalizedPosition.y},setNormalizedPositionY:function(a){this._normalizedPosition.y=a;this.setNodeDirty()},getChildrenCount:function(){return this._children.length},getChildren:function(){return this._children},isVisible:function(){return this._visible},setVisible:function(a){this._visible!=a&&((this._visible=
a)&&this.setNodeDirty(),cc.renderer.childrenOrderDirty=!0)},getAnchorPoint:function(){return cc.p(this._anchorPoint)},setAnchorPoint:function(a,b){var c=this._anchorPoint;if(void 0===b){if(a.x===c.x&&a.y===c.y)return;c.x=a.x;c.y=a.y}else{if(a===c.x&&b===c.y)return;c.x=a;c.y=b}var d=this._anchorPointInPoints,e=this._contentSize;d.x=e.width*c.x;d.y=e.height*c.y;this.setNodeDirty()},_getAnchor:function(){return this._anchorPoint},_setAnchor:function(a){var b=a.x;a=a.y;this._anchorPoint.x!==b&&(this._anchorPoint.x=
b,this._anchorPointInPoints.x=this._contentSize.width*b);this._anchorPoint.y!==a&&(this._anchorPoint.y=a,this._anchorPointInPoints.y=this._contentSize.height*a);this.setNodeDirty()},_getAnchorX:function(){return this._anchorPoint.x},_setAnchorX:function(a){this._anchorPoint.x!==a&&(this._anchorPoint.x=a,this._anchorPointInPoints.x=this._contentSize.width*a,this.setNodeDirty())},_getAnchorY:function(){return this._anchorPoint.y},_setAnchorY:function(a){this._anchorPoint.y!==a&&(this._anchorPoint.y=
a,this._anchorPointInPoints.y=this._contentSize.height*a,this.setNodeDirty())},getAnchorPointInPoints:function(){return cc.p(this._anchorPointInPoints)},_getWidth:function(){return this._contentSize.width},_setWidth:function(a){this._contentSize.width=a;this._anchorPointInPoints.x=a*this._anchorPoint.x;this.setNodeDirty()},_getHeight:function(){return this._contentSize.height},_setHeight:function(a){this._contentSize.height=a;this._anchorPointInPoints.y=a*this._anchorPoint.y;this.setNodeDirty()},
getContentSize:function(){return cc.size(this._contentSize)},setContentSize:function(a,b){var c=this._contentSize;if(void 0===b){if(a.width===c.width&&a.height===c.height)return;c.width=a.width;c.height=a.height}else{if(a===c.width&&b===c.height)return;c.width=a;c.height=b}var d=this._anchorPointInPoints,e=this._anchorPoint;d.x=c.width*e.x;d.y=c.height*e.y;this.setNodeDirty()},isRunning:function(){return this._running},getParent:function(){return this._parent},setParent:function(a){this._parent=a},
isIgnoreAnchorPointForPosition:function(){return this._ignoreAnchorPointForPosition},ignoreAnchorPointForPosition:function(a){a!=this._ignoreAnchorPointForPosition&&(this._ignoreAnchorPointForPosition=a,this.setNodeDirty())},getTag:function(){return this.tag},setTag:function(a){this.tag=a},setName:function(a){this._name=a},getName:function(){return this._name},getUserData:function(){return this.userData},setUserData:function(a){this.userData=a},getUserObject:function(){return this.userObject},setUserObject:function(a){this.userObject!=
a&&(this.userObject=a)},getOrderOfArrival:function(){return this.arrivalOrder},setOrderOfArrival:function(a){this.arrivalOrder=a},getActionManager:function(){this._actionManager||(this._actionManager=cc.director.getActionManager());return this._actionManager},setActionManager:function(a){this._actionManager!=a&&(this.stopAllActions(),this._actionManager=a)},getScheduler:function(){this._scheduler||(this._scheduler=cc.director.getScheduler());return this._scheduler},setScheduler:function(a){this._scheduler!=
...
this.pause()},pause:function(){this.scheduler.pauseTarget(this);this.actionManager&&this.actionManager.pauseTarget(this);cc.eventManager.pauseTarget(this)},setAdditionalTransform:function(a){this._additionalTransform=a;this._additionalTransformDirty=this._transformDirty=!0},getParentToNodeTransform:function(){this._inverseDirty&&(this._inverse=cc.affineTransformInvert(this.getNodeToParentTransform()),this._inverseDirty=!1);return this._inverse},parentToNodeTransform:function(){return this.getParentToNodeTransform()},
getNodeToWorldTransform:function(){for(var a=this.getNodeToParentTransform(),b=this._parent;null!=b;b=b.parent)a=cc.affineTransformConcat(a,b.getNodeToParentTransform());return a},nodeToWorldTransform:function(){return this.getNodeToWorldTransform()},getWorldToNodeTransform:function(){return cc.affineTransformInvert(this.getNodeToWorldTransform())},worldToNodeTransform:function(){return this.getWorldToNodeTransform()},convertToNodeSpace:function(a){return cc.pointApplyAffineTransform(a,this.getWorldToNodeTransform())},
convertToWorldSpace:function(a){a=a||cc.p(0,0);return cc.pointApplyAffineTransform(a,this.getNodeToWorldTransform())},convertToNodeSpaceAR:function(a){return cc.pSub(this.convertToNodeSpace(a),this._anchorPointInPoints)},convertToWorldSpaceAR:function(a){a=a||cc.p(0,0);a=cc.pAdd(a,this._anchorPointInPoints);return this.convertToWorldSpace(a)},_convertToWindowSpace:function(a){a=this.convertToWorldSpace(a);return cc.director.convertToUI(a)},convertTouchToNodeSpace:function(a){a=a.getLocation();return this.convertToNodeSpace(a)},
convertTouchToNodeSpaceAR:function(a){a=a.getLocation();a=cc.director.convertToGL(a);return this.convertToNodeSpaceAR(a)},update:function(a){this._componentContainer&&!this._componentContainer.isEmpty()&&this._componentContainer.visit(a)},updateTransform:function(){this._arrayMakeObjectsPerformSelector(this._children,cc.Node._StateCallbackType.updateTransform)},retain:function(){},release:function(){},getComponent:function(a){return this._componentContainer?this._componentContainer.getComponent(a):
null},addComponent:function(a){this._componentContainer&&this._componentContainer.add(a)},removeComponent:function(a){return this._componentContainer?this._componentContainer.remove(a):!1},removeAllComponents:function(){this._componentContainer&&this._componentContainer.removeAll()},grid:null,ctor:null,visit:null,transform:null,nodeToParentTransform:function(){return this.getNodeToParentTransform()},getNodeToParentTransform:null,_setNodeDirtyForCache:function(){if(!1===this._cacheDirty){this._cacheDirty=
!0;var a=this._cachedParent;a&&a!=this&&a._setNodeDirtyForCache()}},_setCachedParent:function(a){if(this._cachedParent!=a){this._cachedParent=a;for(var b=this._children,c=0,d=b.length;c<d;c++)b[c]._setCachedParent(a)}},getCamera:function(){this._camera||(this._camera=new cc.Camera);return this._camera},getGrid:function(){return this.grid},setGrid:function(a){this.grid=a},getShaderProgram:function(){return this._shaderProgram},setShaderProgram:function(a){this._shaderProgram=a},getGLServerState:function(){return this._glServerState},
setGLServerState:function(a){this._glServerState=a},getBoundingBoxToWorld:function(){var a=cc.rect(0,0,this._contentSize.width,this._contentSize.height),b=this.getNodeToWorldTransform(),a=cc.rectApplyAffineTransform(a,this.getNodeToWorldTransform());if(!this._children)return a;for(var c=this._children,d=0;d<c.length;d++){var e=c[d];e&&e._visible&&(e=e._getBoundingBoxToCurrentNode(b))&&(a=cc.rectUnion(a,e))}return a},_getBoundingBoxToCurrentNode:function(a){var b=cc.rect(0,0,this._contentSize.width,
this._contentSize.height);a=null==a?this.getNodeToParentTransform():cc.affineTransformConcat(this.getNodeToParentTransform(),a);b=cc.rectApplyAffineTransform(b,a);if(!this._children)return b;for(var c=this._children,d=0;d<c.length;d++){var e=c[d];e&&e._visible&&(e=e._getBoundingBoxToCurrentNode(a))&&(b=cc.rectUnion(b,e))}return b},_getNodeToParentTransformForWebGL:function(){if(this._usingNormalizedPosition&&this._parent){var a=this._parent._contentSize;this._position.x=this._normalizedPosition.x*
a.width;this._position.y=this._normalizedPosition.y*a.height;this._normalizedPositionDirty=!1}if(this._transformDirty){var a=this._position.x,b=this._position.y,c=this._anchorPointInPoints.x,d=-c,e=this._anchorPointInPoints.y,f=-e,g=this._scaleX,h=this._scaleY;this._ignoreAnchorPointForPosition&&(a+=c,b+=e);var k=1,n=0,m=1,q=0;if(0!==this._rotationX||0!==this._rotationY)k=Math.cos(-this._rotationRadiansX),n=Math.sin(-this._rotationRadiansX),m=Math.cos(-this._rotationRadiansY),q=Math.sin(-this._rotationRadiansY);
var t=this._skewX||this._skewY;t||0===c&&0===e||(a+=m*d*g+-n*f*h,b+=q*d*g+k*f*h);var r=this._transform;r.a=m*g;r.b=q*g;r.c=-n*h;r.d=k*h;r.tx=a;r.ty=b;t&&(r=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(this._skewY)),c:Math.tan(cc.degreesToRadians(this._skewX)),d:1,tx:0,ty:0},r),0!==c||0!==e)&&(r=cc.affineTransformTranslate(r,d,f));this._additionalTransformDirty&&(r=cc.affineTransformConcat(r,this._additionalTransform),this._additionalTransformDirty=!1);this._transform=r;this._transformDirty=
!1}return this._transform},_updateColor:function(){},getOpacity:function(){return this._realOpacity},getDisplayedOpacity:function(){return this._displayedOpacity},setOpacity:function(a){this._displayedOpacity=this._realOpacity=a;var b=255,c=this._parent;c&&c.cascadeOpacity&&(b=c.getDisplayedOpacity());this.updateDisplayedOpacity(b);this._displayedColor.a=this._realColor.a=a},updateDisplayedOpacity:function(a){this._displayedOpacity=this._realOpacity*a/255;this._rendererCmd&&void 0!==this._rendererCmd._opacity&&
(this._rendererCmd._opacity=this._displayedOpacity/255);if(this._cascadeOpacityEnabled){a=this._children;for(var b=0;b<a.length;b++){var c=a[b];c&&c.updateDisplayedOpacity(this._displayedOpacity)}}},isCascadeOpacityEnabled:function(){return this._cascadeOpacityEnabled},setCascadeOpacityEnabled:function(a){this._cascadeOpacityEnabled!==a&&((this._cascadeOpacityEnabled=a)?this._enableCascadeOpacity():this._disableCascadeOpacity())},_enableCascadeOpacity:function(){var a=255,b=this._parent;b&&b.cascadeOpacity&&
(a=b.getDisplayedOpacity());this.updateDisplayedOpacity(a)},_disableCascadeOpacity:function(){this._displayedOpacity=this._realOpacity;for(var a=this._children,b=0;b<a.length;b++){var c=a[b];c&&c.updateDisplayedOpacity(255)}},getColor:function(){var a=this._realColor;return cc.color(a.r,a.g,a.b,a.a)},getDisplayedColor:function(){var a=this._displayedColor;return cc.color(a.r,a.g,a.b,a.a)},setColor:function(a){var b=this._displayedColor,c=this._realColor;b.r=c.r=a.r;b.g=c.g=a.g;b.b=c.b=a.b;a=(a=this._parent)&&
a.cascadeColor?a.getDisplayedColor():cc.color.WHITE;this.updateDisplayedColor(a)},updateDisplayedColor:function(a){var b=this._displayedColor,c=this._realColor;b.r=0|c.r*a.r/255;b.g=0|c.g*a.g/255;b.b=0|c.b*a.b/255;if(this._cascadeColorEnabled)for(a=this._children,c=0;c<a.length;c++){var d=a[c];d&&d.updateDisplayedColor(b)}},isCascadeColorEnabled:function(){return this._cascadeColorEnabled},setCascadeColorEnabled:function(a){this._cascadeColorEnabled!==a&&((this._cascadeColorEnabled=a)?this._enableCascadeColor():
this._disableCascadeColor())},_enableCascadeColor:function(){var a;a=(a=this._parent)&&a.cascadeColor?a.getDisplayedColor():cc.color.WHITE;this.updateDisplayedColor(a)},_disableCascadeColor:function(){var a=this._displayedColor,b=this._realColor;a.r=b.r;a.g=b.g;a.b=b.b;for(var a=this._children,b=cc.color.WHITE,c=0;c<a.length;c++){var d=a[c];d&&d.updateDisplayedColor(b)}},setOpacityModifyRGB:function(a){},isOpacityModifyRGB:function(){return!1},_initRendererCmd:function(){},_transformForRenderer:null});
cc.Node.create=function(){return new cc.Node};cc.Node._StateCallbackType={onEnter:1,onExit:2,cleanup:3,onEnterTransitionDidFinish:4,updateTransform:5,onExitTransitionDidStart:6,sortAllChildren:7};
if(cc._renderType===cc._RENDER_TYPE_CANVAS){var _p=cc.Node.prototype;_p.ctor=function(){this._initNode();this._initRendererCmd()};_p.setNodeDirty=function(){!1===this._transformDirty&&(this._setNodeDirtyForCache(),this._renderCmdDiry=this._transformDirty=this._inverseDirty=!0,cc.renderer.pushDirtyNode(this))};_p.visit=function(a){if(this._visible){this._parent&&(this._curLevel=this._parent._curLevel+1);var b=this._children,c;this.transform();var d=b.length;if(0<d){this.sortAllChildren();for(a=0;a<
d;a++)if(c=b[a],0>c._localZOrder)c.visit();else break;for(this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);a<d;a++)b[a].visit()}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);this._cacheDirty=!1}};_p._transformForRenderer=function(){var a=this.nodeToParentTransform(),b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;b.a=a.a*c.a+a.b*c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;if(!this._skewX||this._skewY){var d=
this._parent._transform,e=-(d.b+d.c)*a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.tx=a.tx*c.a+a.ty*c.c+c.tx,b.ty=a.tx*c.b+a.ty*c.d+c.ty}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty;this._renderCmdDiry=!1;if(this._children&&0!==this._children.length)for(c=this._children,a=0,b=c.length;a<b;a++)c[a]._transformForRenderer()};_p.transform=function(a){a=this.getNodeToParentTransform();var b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;
b.a=a.a*c.a+a.b*c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;var d=this._parent._transform,e=-(d.b+d.c)*a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty};_p.getNodeToParentTransform=function(){if(this._usingNormalizedPosition&&this._parent){var a=this._parent._contentSize;this._position.x=this._normalizedPosition.x*a.width;this._position.y=this._normalizedPosition.y*a.height;this._normalizedPositionDirty=
!1}if(this._transformDirty){a=this._transform;a.tx=this._position.x;a.ty=this._position.y;var b=1,c=0;this._rotationX&&(b=Math.cos(this._rotationRadiansX),c=Math.sin(this._rotationRadiansX));a.a=a.d=b;a.b=-c;a.c=c;var d=this._scaleX,e=this._scaleY,f=this._anchorPointInPoints.x,g=this._anchorPointInPoints.y,h=1E-6>d&&-1E-6<d?1E-6:d,k=1E-6>e&&-1E-6<e?1E-6:e;if(this._skewX||this._skewY){var n=Math.tan(-this._skewX*Math.PI/180),m=Math.tan(-this._skewY*Math.PI/180);Infinity===n&&(n=99999999);Infinity===
m&&(m=99999999);var q=g*n*h,t=f*m*k;a.a=b+-c*m;a.b=b*n+-c;a.c=c+b*m;a.d=c*n+b;a.tx+=b*q+-c*t;a.ty+=c*q+b*t}if(1!==d||1!==e)a.a*=h,a.c*=h,a.b*=k,a.d*=k;a.tx+=b*-f*h+-c*g*k;a.ty-=c*-f*h+b*g*k;this._ignoreAnchorPointForPosition&&(a.tx+=f,a.ty+=g);this._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(a,this._additionalTransform),this._additionalTransformDirty=!1);this._transformDirty=!1}return this._transform};_p=null}else cc.assert(cc.isFunction(cc._tmp.WebGLCCNode),cc._LogInfos.MissingFile,
"BaseNodesWebGL.js"),cc._tmp.WebGLCCNode(),delete cc._tmp.WebGLCCNode;cc.assert(cc.isFunction(cc._tmp.PrototypeCCNode),cc._LogInfos.MissingFile,"BaseNodesPropertyDefine.js");cc._tmp.PrototypeCCNode();delete cc._tmp.PrototypeCCNode;
...
cc._tmp.WebGLTexture2D(),delete cc._tmp.WebGLTexture2D);cc.EventHelper.prototype.apply(cc.Texture2D.prototype);cc.assert(cc.isFunction(cc._tmp.PrototypeTexture2D),cc._LogInfos.MissingFile,"TexturesPropertyDefine.js");cc._tmp.PrototypeTexture2D();delete cc._tmp.PrototypeTexture2D;
...
function(d,g){if(d)return b?b(d):d;cc.loader.cache[a]=g;cc.textureCache.handleLoadedTexture(a);b&&b.call(c,e)});return e},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLTextureCache),cc._LogInfos.MissingFile,"TexturesWebGL.js"),cc._tmp.WebGLTextureCache(),delete cc._tmp.WebGLTextureCache);cc.Scene=cc.Node.extend({_className:"Scene",ctor:function(){cc.Node.prototype.ctor.call(this);this._ignoreAnchorPointForPosition=!0;this.setAnchorPoint(.5,.5);this.setContentSize(cc.director.getWinSize())}});
...
cc.Layer=cc.Node.extend({_isBaked:!1,_bakeSprite:null,_bakeRenderCmd:null,_className:"Layer",ctor:function(){var a=cc.Node.prototype;a.ctor.call(this);this._ignoreAnchorPointForPosition=!0;a.setAnchorPoint.call(this,.5,.5);a.setContentSize.call(this,cc.winSize)},init:function(){this._ignoreAnchorPointForPosition=!0;this.setAnchorPoint(.5,.5);this.setContentSize(cc.winSize);this.cascadeColor=this.cascadeOpacity=!1;return!0},bake:null,unbake:null,_bakeRendering:null,isBaked:function(){return this._isBaked},
...
cc.generateTintImage=function(a,b,c,d,e){d||(d=cc.rect(0,0,a.width,a.height));a=c.r/255;var f=c.g/255;c=c.b/255;var g=Math.min(d.width,b[0].width),h=Math.min(d.height,b[0].height),k;e?(k=e.getContext("2d"),k.clearRect(0,0,g,h)):(e=cc.newElement("canvas"),e.width=g,e.height=h,k=e.getContext("2d"));k.save();k.globalCompositeOperation="lighter";var n=k.globalAlpha;0<a&&(k.globalAlpha=a*n,k.drawImage(b[0],d.x,d.y,g,h,0,0,g,h));0<f&&(k.globalAlpha=f*n,k.drawImage(b[1],d.x,d.y,g,h,0,0,g,h));0<c&&(k.globalAlpha=
c*n,k.drawImage(b[2],d.x,d.y,g,h,0,0,g,h));1>a+f+c&&(k.globalAlpha=n,k.drawImage(b[3],d.x,d.y,g,h,0,0,g,h));k.restore();return e};
cc.generateTextureCacheForColor=function(a){function b(){var b=cc.generateTextureCacheForColor,d=a.width,g=a.height;c[0].width=d;c[0].height=g;c[1].width=d;c[1].height=g;c[2].width=d;c[2].height=g;c[3].width=d;c[3].height=g;b.canvas.width=d;b.canvas.height=g;var h=b.canvas.getContext("2d");h.drawImage(a,0,0);b.tempCanvas.width=d;b.tempCanvas.height=g;for(var h=h.getImageData(0,0,d,g).data,k=0;4>k;k++){var n=c[k].getContext("2d");n.getImageData(0,0,d,g).data;b.tempCtx.drawImage(a,0,0);for(var m=b.tempCtx.getImageData(0,
0,d,g),q=m.data,t=0;t<h.length;t+=4)q[t]=0===k?h[t]:0,q[t+1]=1===k?h[t+1]:0,q[t+2]=2===k?h[t+2]:0,q[t+3]=h[t+3];n.putImageData(m,0,0)}a.onload=null}if(a.channelCache)return a.channelCache;var c=[cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas"),cc.newElement("canvas")];try{b()}catch(d){a.onload=b}return a.channelCache=c};cc.generateTextureCacheForColor.canvas=cc.newElement("canvas");cc.generateTextureCacheForColor.tempCanvas=cc.newElement("canvas");
...
this._cacheCanvas;c.width=a;c.height=b;this.getTexture().handleLoadedTexture();this.setTextureRect(cc.rect(0,0,a,b),!1)}});
...
n=this._rectFromString(h.textureRect);k&&(n=cc.rect(n.x,n.y,k.width,k.height));d.rect=n;d.rotated=h.textureRotated||!1;d.offset=this._pointFromString(h.spriteOffset);d.size=this._sizeFromString(h.spriteSourceSize);d.aliases=h.aliases}else k=h.frame,n=h.sourceSize,g=h.filename||g,d.rect=cc.rect(k.x,k.y,k.w,k.h),d.rotated=h.rotated||!1,d.offset=cc.p(0,0),d.size=cc.size(n.w,n.h);b[g]=d}}return this._frameConfigCache[a]={_inited:!0,frames:b,meta:e}},addSpriteFrames:function(a,b){cc.assert(a,cc._LogInfos.spriteFrameCache_addSpriteFrames_2);
...
cc.color(255,255,255,128));this._shadowColor.r=a.r;this._shadowColor.g=a.g;this._shadowColor.b=a.b;this._enableShadowNoneColor(b.width||b.x||0,b.height||b.y||0,null!=a.a?a.a/255:.5,c)},_getShadowOffsetX:function(){return this._shadowOffset.x},_setShadowOffsetX:function(a){!1===this._shadowEnabled&&(this._shadowEnabled=!0);this._shadowOffset.x!=a&&(this._shadowOffset.x=a,this._setUpdateTextureDirty())},_getShadowOffsetY:function(){return this._shadowOffset._y},_setShadowOffsetY:function(a){!1===this._shadowEnabled&&
...
d._transformWorld,g=d._offsetPosition.x,h=-d._offsetPosition.y-d._rect.height,k=d._rect.width,n=d._rect.height,m,q="source"!==d._blendFuncStr;m=d._displayedOpacity/255;1!==f.a||0!==f.b||0!==f.c||1!==f.d||d._flippedX||d._flippedY?(a.save(),a.globalAlpha=m,a.transform(f.a,f.c,f.b,f.d,f.tx*b,-f.ty*c),q&&(a.globalCompositeOperation=d._blendFuncStr),d._flippedX&&(g=-g-k,a.scale(-1,1)),d._flippedY&&(h=d._offsetPosition.y,a.scale(1,-1)),d._texture?(m=d._texture._htmlElementObj,d._colorized?a.drawImage(m,
0,0,e.width,e.height,g*b,h*c,k*b,n*c):a.drawImage(m,e.renderX,e.renderY,e.width,e.height,g*b,h*c,k*b,n*c)):(k=d._contentSize,e.validRect&&(d=d._displayedColor,a.fillStyle="rgba("+d.r+","+d.g+","+d.b+",1)",a.fillRect(g*b,h*c,k.width*b,k.height*c))),a.restore()):(q&&(a.save(),a.globalCompositeOperation=d._blendFuncStr),a.globalAlpha=m,d._texture?(m=d._texture.getHtmlElementObj(),d._colorized?a.drawImage(m,0,0,e.width,e.height,(f.tx+g)*b,(-f.ty+h)*c,k*b,n*c):a.drawImage(m,e.renderX,e.renderY,e.width,
e.height,(f.tx+g)*b,(-f.ty+h)*c,k*b,n*c)):(k=d._contentSize,e.validRect&&(d=d._displayedColor,a.fillStyle="rgba("+d.r+","+d.g+","+d.b+",1)",a.fillRect((f.tx+g)*b,(-f.ty+h)*c,k.width*b,k.height*c))),q&&a.restore());cc.g_NumberOfDraws++}},cc.RectRenderCmdCanvas=function(a){this._node=a},cc.RectRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld,f=d._displayedColor,g=d._displayedOpacity/255,h=d._contentSize.width,k=d._contentSize.height;if(0!==
g){var n=1!==e.a||0!==e.b||0!==e.c||1!==e.d,m="source"!==d._blendFuncStr||n;m&&(a.save(),a.globalCompositeOperation=d._blendFuncStr);a.globalAlpha=g;a.fillStyle="rgba("+(0|f.r)+","+(0|f.g)+","+(0|f.b)+", 1)";n?(a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c),a.fillRect(0,0,h*b,-k*c)):a.fillRect(e.tx*b,-e.ty*c,h*b,-k*c);m&&a.restore();cc.g_NumberOfDraws++}},cc.GradientRectRenderCmdCanvas=function(a){this._node=a;this._startPoint=cc.p(0,0);this._endPoint=cc.p(0,0);this._endStopStr=this._startStopStr=null},
...
"source-over";var g;b=this._node.particleCount;c=this._node._particles;if(cc.ParticleSystem.SHAPE_MODE==cc.ParticleSystem.TEXTURE_MODE){if(!d._texture||!d._texture._isLoaded){a.restore();return}var h=d._texture.getHtmlElementObj();if(!h.width||!h.height){a.restore();return}for(var k=cc.textureCache,n=h,d=0;d<b;d++)if(e=c[d],g=e.color.a/255,0!==g){a.globalAlpha=g;a.save();a.translate(0|e.drawPos.x,-(0|e.drawPos.y));var m=4*Math.floor(e.size/4);g=f.width;var q=f.height;a.scale(Math.max(1/g*m,1E-6),
Math.max(1/q*m,1E-6));e.rotation&&a.rotate(cc.degreesToRadians(e.rotation));e.isChangeColor&&(m=k.getTextureColors(h))&&(m.tintCache||(m.tintCache=cc.newElement("canvas"),m.tintCache.width=h.width,m.tintCache.height=h.height),cc.generateTintImage(h,m,e.color,this._pointRect,m.tintCache),n=m.tintCache);a.drawImage(n,-(0|g/2),-(0|q/2));a.restore()}}else for(h=cc._drawingUtil,d=0;d<b;d++)e=c[d],f=0|.5*e.size,g=e.color.a/255,0!==g&&(a.globalAlpha=g,a.save(),a.translate(0|e.drawPos.x,-(0|e.drawPos.y)),
...
new cc.MoveBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._positionDelta);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var b=a.getNormalizedPositionX();a=a.getNormalizedPositionY();this._previousPosition.x=b;this._previousPosition.y=a;this._startPosition.x=b;this._startPosition.y=a},update:function(a){a=this._computeEaseTime(a);if(this.target){var b=this._positionDelta.x*a;a*=this._positionDelta.y;var c=this._startPosition;if(cc.ENABLE_STACKABLE_ACTIONS){var d=
this.target.getNormalizedPositionX(),e=this.target.getNormalizedPositionY(),f=this._previousPosition;c.x=c.x+d-f.x;c.y=c.y+e-f.y;b+=c.x;a+=c.y;f.x=b;f.y=a;this.target.setNormalizedPosition(b,a)}else this.target.setNormalizedPosition(c.x+b,c.y+a)}},reverse:function(){var a=new cc.MoveBy(this._duration,cc.p(-this._positionDelta.x,-this._positionDelta.y));this._cloneDecoration(a);this._reverseEaseList(a);return a}});cc.moveBy=function(a,b,c){return new cc.MoveBy(a,b,c)};cc.MoveBy.create=cc.moveBy;
...
a);this._positionDelta.x=this._endPosition.x-a.getNormalizedPositionX();this._positionDelta.y=this._endPosition.y-a.getNormalizedPositionY()}});cc.moveTo=function(a,b,c){return new cc.MoveTo(a,b,c)};cc.MoveTo.create=cc.moveTo;
...
e,!0):!1},clone:function(){var a=new cc.JumpBy;this._cloneDecoration(a);a.initWithDuration(this._duration,this._delta,this._height,this._jumps);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var b=a.getNormalizedPositionX();a=a.getNormalizedPositionY();this._previousPosition.x=b;this._previousPosition.y=a;this._startPosition.x=b;this._startPosition.y=a},update:function(a){a=this._computeEaseTime(a);if(this.target){var b=a*this._jumps%1,b=4*this._height*
b*(1-b),b=b+this._delta.y*a;a*=this._delta.x;var c=this._startPosition;if(cc.ENABLE_STACKABLE_ACTIONS){var d=this.target.getNormalizedPositionX(),e=this.target.getNormalizedPositionY(),f=this._previousPosition;c.x=c.x+d-f.x;c.y=c.y+e-f.y;a+=c.x;b+=c.y;f.x=a;f.y=b;this.target.setNormalizedPosition(a,b)}else this.target.setNormalizedPosition(c.x+a,c.y+b)}},reverse:function(){var a=new cc.JumpBy(this._duration,cc.p(-this._delta.x,-this._delta.y),this._height,this._jumps);this._cloneDecoration(a);this._reverseEaseList(a);
return a}});cc.jumpBy=function(a,b,c,d,e){return new cc.JumpBy(a,b,c,d,e)};cc.JumpBy.create=cc.jumpBy;
...
this._config[c];b.push(cc.p(d.x,d.y))}a.initWithDuration(this._duration,b);return a},startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a);var b=a.getNormalizedPositionX();a=a.getNormalizedPositionY();this._previousPosition.x=b;this._previousPosition.y=a;this._startPosition.x=b;this._startPosition.y=a},update:function(a){a=this._computeEaseTime(a);if(this.target){var b=this._config,c=b[0].y,d=b[1].y,e=b[2].y,b=cc.bezierAt(0,b[0].x,b[1].x,b[2].x,a);a=cc.bezierAt(0,c,
d,e,a);c=this._startPosition;if(cc.ENABLE_STACKABLE_ACTIONS){var d=this.target.getNormalizedPositionX(),e=this.target.getNormalizedPositionY(),f=this._previousPosition;c.x=c.x+d-f.x;c.y=c.y+e-f.y;b+=c.x;a+=c.y;f.x=b;f.y=a;this.target.setNormalizedPosition(b,a)}else this.target.setNormalizedPosition(c.x+b,c.y+a)}},reverse:function(){var a=this._config,a=[cc.pAdd(a[1],cc.pNeg(a[2])),cc.pAdd(a[0],cc.pNeg(a[2])),cc.pNeg(a[2])],a=new cc.BezierBy(this._duration,a);this._cloneDecoration(a);this._reverseEaseList(a);
return a}});cc.bezierBy=function(a,b){return new cc.BezierBy(a,b)};cc.BezierBy.create=cc.bezierBy;
...
cc.EaseElasticInOut=cc.EaseElastic.extend({update:function(a){var b=0,b=this._period;if(0===a||1==a)b=a;else{b||(b=this._period=.3*1.5);var c=b/4;a=2*a-1;b=0>a?-.5*Math.pow(2,10*a)*Math.sin((a-c)*Math.PI*2/b):Math.pow(2,-10*a)*Math.sin((a-c)*Math.PI*2/b)*.5+1}this._inner.update(b)},reverse:function(){return new cc.EaseElasticInOut(this._inner.reverse(),this._period)},clone:function(){var a=new cc.EaseElasticInOut;a.initWithAction(this._inner.clone(),this._period);return a}});
...
cc.EaseBounceInOut=cc.EaseBounce.extend({update:function(a){var b=0,b=.5>a?.5*(1-this.bounceTime(1-2*a)):.5*this.bounceTime(2*a-1)+.5;this._inner.update(b)},clone:function(){var a=new cc.EaseBounceInOut;a.initWithAction(this._inner.clone());return a},reverse:function(){return new cc.EaseBounceInOut(this._inner.reverse())}});cc.EaseBounceInOut.create=function(a){return new cc.EaseBounceInOut(a)};
cc._easeBounceInOutObj={easing:function(a){return a=.5>a?.5*(1-cc._bounceTime(1-2*a)):.5*cc._bounceTime(2*a-1)+.5},reverse:function(){return cc._easeBounceInOutObj}};cc.easeBounceInOut=function(){return cc._easeBounceInOutObj};cc.EaseBackIn=cc.ActionEase.extend({update:function(a){this._inner.update(0===a||1==a?a:a*a*(2.70158*a-1.70158))},reverse:function(){return new cc.EaseBackOut(this._inner.reverse())},clone:function(){var a=new cc.EaseBackIn;a.initWithAction(this._inner.clone());return a}});
...
cc.EaseQuinticActionOut=cc.ActionEase.extend({_updateTime:function(a){--a;return a*a*a*a*a+1},update:function(a){this._inner.update(this._updateTime(a))},clone:function(){var a=new cc.EaseQuinticActionOut;a.initWithAction(this._inner.clone());return a},reverse:function(){return new cc.EaseQuinticActionOut(this._inner.reverse())}});cc.EaseQuinticActionOut.create=function(a){return new cc.EaseQuinticActionOut(a)};cc._easeQuinticActionOut={easing:cc.EaseQuinticActionOut.prototype._updateTime,reverse:function(){return cc._easeQuinticActionOut}};
cc.easeQuinticActionOut=function(){return cc._easeQuinticActionOut};cc.EaseQuinticActionInOut=cc.ActionEase.extend({_updateTime:function(a){a*=2;if(1>a)return.5*a*a*a*a*a;a-=2;return.5*(a*a*a*a*a+2)},update:function(a){this._inner.update(this._updateTime(a))},clone:function(){var a=new cc.EaseQuinticActionInOut;a.initWithAction(this._inner.clone());return a},reverse:function(){return new cc.EaseQuinticActionInOut(this._inner.reverse())}});cc.EaseQuinticActionInOut.create=function(a){return new cc.EaseQuinticActionInOut(a)};
...
cc.EaseCircleActionOut=cc.ActionEase.extend({_updateTime:function(a){--a;return Math.sqrt(1-a*a)},update:function(a){this._inner.update(this._updateTime(a))},clone:function(){var a=new cc.EaseCircleActionOut;a.initWithAction(this._inner.clone());return a},reverse:function(){return new cc.EaseCircleActionOut(this._inner.reverse())}});cc.EaseCircleActionOut.create=function(a){return new cc.EaseCircleActionOut(a)};cc._easeCircleActionOut={easing:cc.EaseCircleActionOut.prototype._updateTime,reverse:function(){return cc._easeCircleActionOut}};
cc.easeCircleActionOut=function(){return cc._easeCircleActionOut};cc.EaseCircleActionInOut=cc.ActionEase.extend({_updateTime:function(a){a*=2;if(1>a)return-.5*(Math.sqrt(1-a*a)-1);a-=2;return.5*(Math.sqrt(1-a*a)+1)},update:function(a){this._inner.update(this._updateTime(a))},clone:function(){var a=new cc.EaseCircleActionInOut;a.initWithAction(this._inner.clone());return a},reverse:function(){return new cc.EaseCircleActionInOut(this._inner.reverse())}});cc.EaseCircleActionInOut.create=function(a){return new cc.EaseCircleActionInOut(a)};
...
_onSuccess:function(a){this._buffer=a;a=this._events.success;var b=this._events.canplaythrough;a&&a();b&&b();0!=this._loadState&&"autoplay"!=this.autoplay&&1!=this.autoplay||this._play();this._loadState=1},_onError:function(){var a=this._events.error;a&&a();this._loadState=-2},cloneNode:function(){var a=new cc.WebAudio(this.src);a.volume=this.volume;a._loadState=this._loadState;a._buffer=this._buffer;0!=a._loadState&&-1!=a._loadState||a.load();return a}});_p=cc.WebAudio.prototype;_p.loop;cc.defineGetterSetter(_p,
"loop",function(){return this._loop},function(a){this._loop=a;this._sourceNode&&(this._sourceNode.loop=a)});_p.volume;cc.defineGetterSetter(_p,"volume",function(){return this._volume},function(a){this._volume=a;this._volumeNode.gain.value=a});_p.paused;cc.defineGetterSetter(_p,"paused",function(){return this._paused});_p.ended;cc.defineGetterSetter(_p,"ended",function(){var a=this._sourceNode;return this._paused?!1:this._stopped&&!a?!0:null==a.playbackState?a._stopped:3==a.playbackState});_p.played;
cc.defineGetterSetter(_p,"played",function(){var a=this._sourceNode;return a&&(2==a.playbackState||!a._stopped)})}
...
cc._audioLoader._supportedAudioTypes=function(){var a=cc.newElement("audio"),b=[];if(a.canPlayType){var c=function(b){b=a.canPlayType(b);return"no"!=b&&""!=b};c('audio/ogg; codecs="vorbis"')&&b.push(".ogg");c("audio/mpeg")&&b.push(".mp3");c('audio/wav; codecs="1"')&&b.push(".wav");c("audio/mp4")&&b.push(".mp4");(c("audio/x-m4a")||c("audio/aac"))&&b.push(".m4a")}return b}();cc.loader.register(["mp3","ogg","wav","mp4","m4a"],cc._audioLoader);
cc.audioEngine=cc.AudioEngineForSingle?new cc.AudioEngineForSingle:new cc.AudioEngine;cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()});cc.v2fzero=function(){return{x:0,y:0}};cc.v2f=function(a,b){return{x:a,y:b}};cc.v2fadd=function(a,b){return cc.v2f(a.x+b.x,a.y+b.y)};cc.v2fsub=function(a,b){return cc.v2f(a.x-b.x,a.y-b.y)};
...
(e.a=255);a=[a,cc.p(b.x,a.y),b,cc.p(a.x,b.y)];b=new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);b.verts=a;b.lineWidth=d;b.lineColor=e;b.isClosePolygon=!0;b.isStroke=!0;b.lineCap="butt";if(b.fillColor=c)null==c.a&&(c.a=255),b.isFill=!0;this._buffer.push(b)},drawCircle:function(a,b,c,d,e,f,g){f=f||this._lineWidth;g=g||this.getDrawColor();null==g.a&&(g.a=255);for(var h=2*Math.PI/d,k=[],n=0;n<=d;n++){var m=n*h,q=b*Math.cos(m+c)+a.x,m=b*Math.sin(m+c)+a.y;k.push(cc.p(q,m))}e&&k.push(cc.p(a.x,a.y));a=new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);
a.verts=k;a.lineWidth=f;a.lineColor=g;a.isClosePolygon=!0;a.isStroke=!0;this._buffer.push(a)},drawQuadBezier:function(a,b,c,d,e,f){e=e||this._lineWidth;f=f||this.getDrawColor();null==f.a&&(f.a=255);for(var g=[],h=0,k=0;k<d;k++){var n=Math.pow(1-h,2)*a.x+2*(1-h)*h*b.x+h*h*c.x,m=Math.pow(1-h,2)*a.y+2*(1-h)*h*b.y+h*h*c.y;g.push(cc.p(n,m));h+=1/d}g.push(cc.p(c.x,c.y));a=new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);a.verts=g;a.lineWidth=e;a.lineColor=f;a.isStroke=!0;a.lineCap="round";this._buffer.push(a)},
drawCubicBezier:function(a,b,c,d,e,f,g){f=f||this._lineWidth;g=g||this.getDrawColor();null==g.a&&(g.a=255);for(var h=[],k=0,n=0;n<e;n++){var m=Math.pow(1-k,3)*a.x+3*Math.pow(1-k,2)*k*b.x+3*(1-k)*k*k*c.x+k*k*k*d.x,q=Math.pow(1-k,3)*a.y+3*Math.pow(1-k,2)*k*b.y+3*(1-k)*k*k*c.y+k*k*k*d.y;h.push(cc.p(m,q));k+=1/e}h.push(cc.p(d.x,d.y));a=new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);a.verts=h;a.lineWidth=f;a.lineColor=g;a.isStroke=!0;a.lineCap="round";this._buffer.push(a)},drawCatmullRom:function(a,b,
c,d){this.drawCardinalSpline(a,.5,b,c,d)},drawCardinalSpline:function(a,b,c,d,e){d=d||this._lineWidth;e=e||this.getDrawColor();null==e.a&&(e.a=255);for(var f=[],g,h,k=1/a.length,n=0;n<c+1;n++)h=n/c,1==h?(g=a.length-1,h=1):(g=0|h/k,h=(h-k*g)/k),g=cc.cardinalSplineAt(cc.getControlPointAt(a,g-1),cc.getControlPointAt(a,g-0),cc.getControlPointAt(a,g+1),cc.getControlPointAt(a,g+2),b,h),f.push(g);a=new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);a.verts=f;a.lineWidth=d;a.lineColor=e;a.isStroke=!0;a.lineCap=
...
e=b.fillColor,f=b.lineWidth,g=b.lineColor,h=b.isClosePolygon,k=b.isFill,n=b.isStroke;if(null!=c){var m=c[0],q=cc.view.getScaleX(),t=cc.view.getScaleY();a.lineCap=d;e&&(a.fillStyle="rgba("+(0|e.r)+","+(0|e.g)+","+(0|e.b)+","+e.a/255+")");f&&(a.lineWidth=f*q);g&&(a.strokeStyle="rgba("+(0|g.r)+","+(0|g.g)+","+(0|g.b)+","+g.a/255+")");a.beginPath();a.moveTo(m.x*q,-m.y*t);d=1;for(e=c.length;d<e;d++)a.lineTo(c[d].x*q,-c[d].y*t);h&&a.closePath();k&&a.fill();n&&a.stroke()}},clear:function(){this._buffer.length=
0}});
...
this._drawColor;b.r=a.r;b.g=a.g;b.b=a.b;b.a=a.a},getDrawColor:function(){return cc.color(this._drawColor.r,this._drawColor.g,this._drawColor.b,this._drawColor.a)},drawRect:function(a,b,c,d,e){d=d||this._lineWidth;e=e||this.getDrawColor();null==e.a&&(e.a=255);a=[a,cc.p(b.x,a.y),b,cc.p(a.x,b.y)];null==c?this._drawSegments(a,d,e,!0):this.drawPoly(a,c,d,e)},drawCircle:function(a,b,c,d,e,f,g){f=f||this._lineWidth;g=g||this.getDrawColor();null==g.a&&(g.a=255);var h=2*Math.PI/d,k=[],n;for(n=0;n<=d;n++){var m=
n*h,q=b*Math.cos(m+c)+a.x,m=b*Math.sin(m+c)+a.y;k.push(cc.p(q,m))}e&&k.push(cc.p(a.x,a.y));f*=.5;n=0;for(a=k.length;n<a-1;n++)this.drawSegment(k[n],k[n+1],f,g)},drawQuadBezier:function(a,b,c,d,e,f){e=e||this._lineWidth;f=f||this.getDrawColor();null==f.a&&(f.a=255);for(var g=[],h=0,k=0;k<d;k++){var n=Math.pow(1-h,2)*a.x+2*(1-h)*h*b.x+h*h*c.x,m=Math.pow(1-h,2)*a.y+2*(1-h)*h*b.y+h*h*c.y;g.push(cc.p(n,m));h+=1/d}g.push(cc.p(c.x,c.y));this._drawSegments(g,e,f,!1)},drawCubicBezier:function(a,b,c,d,e,f,
g){f=f||this._lineWidth;g=g||this.getDrawColor();null==g.a&&(g.a=255);for(var h=[],k=0,n=0;n<e;n++){var m=Math.pow(1-k,3)*a.x+3*Math.pow(1-k,2)*k*b.x+3*(1-k)*k*k*c.x+k*k*k*d.x,q=Math.pow(1-k,3)*a.y+3*Math.pow(1-k,2)*k*b.y+3*(1-k)*k*k*c.y+k*k*k*d.y;h.push(cc.p(m,q));k+=1/e}h.push(cc.p(d.x,d.y));this._drawSegments(h,f,g,!1)},drawCatmullRom:function(a,b,c,d){this.drawCardinalSpline(a,.5,b,c,d)},drawCardinalSpline:function(a,b,c,d,e){d=d||this._lineWidth;e=e||this.getDrawColor();null==e.a&&(e.a=255);
for(var f=[],g,h,k=1/a.length,n=0;n<c+1;n++)h=n/c,1==h?(g=a.length-1,h=1):(g=0|h/k,h=(h-k*g)/k),g=cc.cardinalSplineAt(cc.getControlPointAt(a,g-1),cc.getControlPointAt(a,g-0),cc.getControlPointAt(a,g+1),cc.getControlPointAt(a,g+2),b,h),f.push(g);d*=.5;a=0;for(b=f.length;a<b-1;a++)this.drawSegment(f[a],f[a+1],d,e)},_render:function(){var a=cc._renderContext;cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POS_COLOR_TEX);a.bindBuffer(a.ARRAY_BUFFER,this._trianglesWebBuffer);this._dirty&&(a.bufferData(a.ARRAY_BUFFER,
...
b))},{vertices:e,colors:d,texCoords:cc.__t(cc.v2fadd(b,a))},{vertices:q,colors:d,texCoords:cc.__t(b)},h,r.length*g));this._dirty=!0},drawPoly:function(a,b,c,d){if(null==b)this._drawSegments(a,c,d,!0);else{null==b.a&&(b.a=255);null==d.a&&(d.a=255);c=c||this._lineWidth;c*=.5;b={r:0|b.r,g:0|b.g,b:0|b.b,a:0|b.a};d={r:0|d.r,g:0|d.g,b:0|d.b,a:0|d.a};var e=[],f,g,h,k,n=a.length;for(f=0;f<n;f++){g=cc.__v2f(a[(f-1+n)%n]);h=cc.__v2f(a[f]);k=cc.__v2f(a[(f+1)%n]);var m=cc.v2fnormalize(cc.v2fperp(cc.v2fsub(h,
g)));h=cc.v2fnormalize(cc.v2fperp(cc.v2fsub(k,h)));m=cc.v2fmult(cc.v2fadd(m,h),1/(cc.v2fdot(m,h)+1));e[f]={offset:m,n:h}}m=0<c;this._ensureCapacity(3*(3*n-2));var q=cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT,t=this._trianglesArrayBuffer,r=this._buffer,u=0==m?.5:0;for(f=0;f<n-2;f++)g=cc.v2fsub(cc.__v2f(a[0]),cc.v2fmult(e[0].offset,u)),h=cc.v2fsub(cc.__v2f(a[f+1]),cc.v2fmult(e[f+1].offset,u)),k=cc.v2fsub(cc.__v2f(a[f+2]),cc.v2fmult(e[f+2].offset,u)),r.push(new cc.V2F_C4B_T2F_Triangle({vertices:g,colors:b,
texCoords:cc.__t(cc.v2fzero())},{vertices:h,colors:b,texCoords:cc.__t(cc.v2fzero())},{vertices:k,colors:b,texCoords:cc.__t(cc.v2fzero())},t,r.length*q));for(f=0;f<n;f++){u=(f+1)%n;g=cc.__v2f(a[f]);h=cc.__v2f(a[u]);k=e[f].n;var v=e[f].offset,x=e[u].offset,u=m?cc.v2fsub(g,cc.v2fmult(v,c)):cc.v2fsub(g,cc.v2fmult(v,.5)),w=m?cc.v2fsub(h,cc.v2fmult(x,c)):cc.v2fsub(h,cc.v2fmult(x,.5));g=m?cc.v2fadd(g,cc.v2fmult(v,c)):cc.v2fadd(g,cc.v2fmult(v,.5));h=m?cc.v2fadd(h,cc.v2fmult(x,c)):cc.v2fadd(h,cc.v2fmult(x,
.5));m?(r.push(new cc.V2F_C4B_T2F_Triangle({vertices:u,colors:d,texCoords:cc.__t(cc.v2fneg(k))},{vertices:w,colors:d,texCoords:cc.__t(cc.v2fneg(k))},{vertices:h,colors:d,texCoords:cc.__t(k)},t,r.length*q)),r.push(new cc.V2F_C4B_T2F_Triangle({vertices:u,colors:d,texCoords:cc.__t(cc.v2fneg(k))},{vertices:g,colors:d,texCoords:cc.__t(k)},{vertices:h,colors:d,texCoords:cc.__t(k)},t,r.length*q))):(r.push(new cc.V2F_C4B_T2F_Triangle({vertices:u,colors:b,texCoords:cc.__t(cc.v2fzero())},{vertices:w,colors:b,
texCoords:cc.__t(cc.v2fzero())},{vertices:h,colors:b,texCoords:cc.__t(k)},t,r.length*q)),r.push(new cc.V2F_C4B_T2F_Triangle({vertices:u,colors:b,texCoords:cc.__t(cc.v2fzero())},{vertices:g,colors:b,texCoords:cc.__t(k)},{vertices:h,colors:b,texCoords:cc.__t(k)},t,r.length*q)))}this._dirty=!0}},_drawSegments:function(a,b,c,d){b=b||this._lineWidth;c=c||this._drawColor;null==c.a&&(c.a=255);b*=.5;if(!(0>=b)){c={r:0|c.r,g:0|c.g,b:0|c.b,a:0|c.a};var e=[],f,g,h,k,n=a.length;for(f=0;f<n;f++){g=cc.__v2f(a[(f-
1+n)%n]);h=cc.__v2f(a[f]);k=cc.__v2f(a[(f+1)%n]);var m=cc.v2fnormalize(cc.v2fperp(cc.v2fsub(h,g)));h=cc.v2fnormalize(cc.v2fperp(cc.v2fsub(k,h)));k=cc.v2fmult(cc.v2fadd(m,h),1/(cc.v2fdot(m,h)+1));e[f]={offset:k,n:h}}this._ensureCapacity(3*(3*n-2));k=cc.V2F_C4B_T2F_Triangle.BYTES_PER_ELEMENT;var m=this._trianglesArrayBuffer,q=this._buffer;d=d?n:n-1;for(f=0;f<d;f++){var t=(f+1)%n;g=cc.__v2f(a[f]);h=cc.__v2f(a[t]);var r=e[f].n,u=e[f].offset,v=e[t].offset,t=cc.v2fsub(g,cc.v2fmult(u,b)),x=cc.v2fsub(h,cc.v2fmult(v,
b));g=cc.v2fadd(g,cc.v2fmult(u,b));h=cc.v2fadd(h,cc.v2fmult(v,b));q.push(new cc.V2F_C4B_T2F_Triangle({vertices:t,colors:c,texCoords:cc.__t(cc.v2fneg(r))},{vertices:x,colors:c,texCoords:cc.__t(cc.v2fneg(r))},{vertices:h,colors:c,texCoords:cc.__t(r)},m,q.length*k));q.push(new cc.V2F_C4B_T2F_Triangle({vertices:t,colors:c,texCoords:cc.__t(cc.v2fneg(r))},{vertices:g,colors:c,texCoords:cc.__t(r)},{vertices:h,colors:c,texCoords:cc.__t(r)},m,q.length*k))}this._dirty=!0}},clear:function(){this._buffer.length=
0;this._dirty=!0}});cc.DrawNode=cc._renderType==cc._RENDER_TYPE_WEBGL?cc.DrawNodeWebGL:cc.DrawNodeCanvas;cc.DrawNode.create=function(){return new cc.DrawNode};cc._DrawNodeElement=function(a,b,c,d,e,f,g,h,k){this.type=a;this.verts=b||null;this.fillColor=c||null;this.lineWidth=d||0;this.lineColor=e||null;this.lineCap=f||"butt";this.isClosePolygon=g||!1;this.isFill=h||!1;this.isStroke=k||!1};cc.DrawNode.TYPE_DOT=0;cc.DrawNode.TYPE_SEGMENT=1;cc.DrawNode.TYPE_POLY=2;var acg=acg||{};acg.p=cc.p;acg.colour=cc.color;acg.ALIGN_LEFT=cc.TEXT_ALIGNMENT_LEFT;acg.ALIGN_CENTRE=cc.TEXT_ALIGNMENT_CENTER;acg.ALIGN_RIGHT=cc.TEXT_ALIGNMENT_RIGHT;acg.ALILGN_TOP=cc.VERTICAL_TEXT_ALIGNMENT_TOP;acg.ALILGN_BOTTOM=cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM;acg.matters=[];acg._init_callbacks=[];acg.place=function(a){if(a=acg.matters[a])a._acg_parent.addChild(a),acg.apply_attr(a,a._acg_attr),a._acg_action&&a._acg_action.startWithTarget(a)};
acg.sweep=function(a){(a=acg.matters[a])&&a._acg_parent.removeChild(a,!1)};acg.action_duration=function(a){var b;return(b=acg.matters[a]._acg_action)?b.getDuration():0};acg.matter=function(a){return acg.matters[a]};
acg.apply_attr=function(a,b){void 0==b.x&&void 0==b.y&&(b.x=b.y=.5);void 0==b.ax&&void 0==b.ay&&(b.ax=b.ay=.5);a.setNormalizedPosition(b.x,b.y);a.setAnchorPoint(b.ax,b.ay);a.setScale(b.scale||1);b.colour?a.setColor(b.colour[0]?cc.color.apply(null,b.colour):b.colour):a.setColor(cc.color.WHITE);a.setOpacity(255*b.opacity||255);a.setRotation(b.rotation||0);a.setLocalZOrder(b.zorder||0);a.setVisible(b.visible||!0);a instanceof cc.LabelTTF&&(a.setFontName(b.fontname||"Arial"),a.setFontSize(b.fontsize||
24),a.setHorizontalAlignment(b.halign||acg.ALIGN_CENTRE),a.setVerticalAlignment(b.valign||acg.ALIGN_CENTRE),a.setDimensions(b.size||cc.size(0,0)),a.setString(b.text||"WHAT DO I NEED TO SAY??"));a instanceof cc.Sprite?(a.setFlippedX(b.flipx||!1),a.setFlippedY(b.flipy||!1)):a instanceof cc.Layer&&(b.width=b.width||1,b.height=b.height||1,a._setWidth(b.width*acg.width),a._setHeight(b.height*acg.height))};acg=acg||{};acg.EVENT_ENTER=0;acg.EVENT_LEAVE=1;acg._flow=[];acg._flow_tmp=[];acg._last_flow_idx=-1;acg.time=0;acg.paused=!0;acg.timescale=1;acg._tottime=0;acg._offsets=[];acg._cur_offset=0;acg._onpause_callbacks=[];acg._onresume_callbacks=[];acg.putOne=function(a,b){a+=acg._cur_offset;acg.matters[b]._acg_entertime=a;acg._flow_tmp.push({time:a,type:acg.EVENT_ENTER,id:b});acg._flow_tmp.push({time:a+acg.action_duration(b),type:acg.EVENT_LEAVE,id:b})};
acg.put=function(a,b){if(isFinite(b))acg.putOne(a,b);else if("undefined"!==typeof b.length)for(var c=0;c<b.length;c++)acg.putOne(a,b[c])};acg.begin_offset=function(a){acg._cur_offset+=a;acg._offsets.push(a)};acg.end_offset=function(){acg._cur_offset-=acg._offsets.pop()};acg.sort=function(a,b,c){void 0===b&&(b=0,c=a.length-1);for(var d=b,e=c,f=a[b+c>>1].time,g;d<=e;){for(;a[d].time<f;)d++;for(;a[e].time>f;)e--;d<=e&&(g=a[d],a[d]=a[e],a[e]=g,d++,e--)}d<c&&acg.sort(a,d,c);e>b&&acg.sort(a,b,e)};
acg.find=function(a,b){if(b<a[0].time)return-1;for(var c=0,d=a.length-1;c<d-1;){var e=c+d>>1;a[e].time>=b?d=e:c=e}for(a[c+1].time===b&&c++;0<c&&a[c].time===a[c-1].time;)c--;return c};acg.tot_time=function(){if(0<acg._tottime)return acg._tottime;var a=-1;acg._flow_tmp.forEach(function(b){b.time>a&&(a=b.time)});return a};
acg.commit=function(){acg._flow=[];acg.sort(acg._flow_tmp);acg._tottime=acg._flow_tmp[acg._flow_tmp.length-1];for(var a=-1,b=0;b<acg._flow_tmp.length;b++){var c=acg._flow_tmp[b];.01>=Math.abs(c.time-a)?acg._flow[acg._flow.length-1].events.push(c):(acg._flow.push({time:c.time,events:[c]}),a=c.time)}acg._flow[-1]={present:[]};for(b=0;b<acg._flow.length;b++){var c=acg._flow[b],d=acg._flow[b-1].present.slice();c.events.forEach(function(a){if(a.type===acg.EVENT_LEAVE)for(var b=0;b<d.length;b++)d[b]===
a.id&&(d[b]=-1);else d.push(a.id)});c.present=[];for(a=0;a<d.length;a++)-1!==d[a]&&c.present.push(d[a]);acg._flow[b]=c}};acg.travel=function(a){var b=acg.find(acg._flow,acg.time);-1!==b&&acg._flow[b].present.forEach(function(a){acg.sweep(a)});b=acg.find(acg._flow,a);-1!==b&&acg._flow[b].present.forEach(function(a){acg.place(a)});acg._last_flow_idx=acg.find(acg._flow,a);acg.time=a;acg.update(0);acg.update(0)};
acg.update=function(a){acg.time+=a*acg.timescale;acg.time>acg.tot_time()&&(acg.time=acg.tot_time(),acg.pause());a=acg.find(acg._flow,acg.time);acg._last_flow_idx!==a&&(acg._flow[a].events.forEach(function(a){a.type===acg.EVENT_LEAVE?acg.sweep(a.id):acg.place(a.id)}),acg._last_flow_idx=a);acg._flow[a].present.forEach(function(a){a=acg.matters[a];a._acg_action.step(acg.time-a._acg_entertime-a._acg_action.getElapsed())})};acg.pause=function(){acg.paused||(acg.paused=!0,acg.scene.unscheduleUpdate(),acg._onpause_callbacks.forEach(function(a){a()}))};
acg.resume=function(){acg.paused&&(acg.paused=!1,acg.scene.scheduleUpdate(),acg._onresume_callbacks.forEach(function(a){a()}))};acg.set_timescale=function(a){acg.timescale=a};acg._init_callbacks.push(function(){acg.scene.update=acg.update;acg.resume()});acg=acg||{};cc=cc||{};acg.width=0;acg.height=0;acg.scene=null;
acg.bootstrap=function(a,b,c){cc.game.onStart=function(){cc.view.adjustViewPort(!0);acg.width=320*b;acg.height=320;cc.view.setDesignResolutionSize(acg.width,acg.height,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.director.setDisplayStats(!0);cc.director.runScene(new cc.Scene)};cc.game.run(a);var d=setInterval(function(){acg.scene=cc.director.getRunningScene();cc.director&&cc.director.getRunningScene()&&(clearInterval(d),c&&c(),acg._init_callbacks.forEach(function(a){a()}))},
300)};acg=acg||{};acg.ac=acg.ac||{};acg.init_matter=function(a,b,c,d){acg.apply_attr(a,b);a._acg_action=c?acg.ac.parse(c):acg.emptyAction;if(d){a._acg_parent=d;c=0;var e=a._acg_action.getDuration();(_ref=d._acg_action)&&(c=_ref.getDuration())>e&&(a._acg_action=cc.Sequence.create(a._acg_action,cc.DelayTime.create(c-e)))}else a._acg_parent=acg.scene;a._acg_id=acg.matters.push(a)-1;a._acg_attr=b};acg.img=function(a,b,c){a=cc.Sprite.create(a);acg.init_matter(a,b,c);return a._acg_id};
acg.text=function(a,b){var c=cc.LabelTTF.create();acg.init_matter(c,a,b);return c._acg_id};acg.rect=function(a,b){var c=cc.LayerColor.create();acg.init_matter(c,a,b);return c._acg_id};acg=acg||{};acg.ac=acg.ac||{};cc=cc||{};acg.emptyAction=cc.ActionInterval.create(0);
acg.ac.ChangeString=cc.ActionInstant.extend({_str:"",ctor:function(a){cc.FiniteTimeAction.prototype.ctor.call(this);this._str="";void 0!==a&&this.initWithString(a)},initWithString:function(a){this._str=a;return!0},update:function(a){this.target instanceof cc.LabelTTF&&this.target.setString(this._str)},reverse:function(){console.log("acg.ac.ChangeString.reverse(): Not supported")},clone:function(){var a=new acg.ac.ChangeString;a.initWithString(this._str);return a}});acg.ac.changeString=function(a){return new acg.ac.ChangeString(a)};
acg.ac.GoNumber=cc.ActionInterval.extend({_targetNum:0,_startNum:0,ctor:function(a,b){cc.ActionInterval.prototype.ctor.call(this);void 0!==b&&this.initWithDuration(a,b)},initWithDuration:function(a,b){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._targetNum=b,!0):!1},clone:function(){var a=new acg.ac.GoNumber;this._cloneDecoration(a);a.initWithDuration(this._duration,this._targetNum);return a},startWithTarget:function(a){a instanceof cc.LabelTTF&&(cc.ActionInterval.prototype.startWithTarget.call(this,
a),this._startNum=parseInt(a.getString(),10))},update:function(a){a=this._computeEaseTime(a);this.target&&this.target.setString(Math.floor(this._startNum*(1-a)+this._targetNum*a).toString())},reverse:function(){console.log("acg.ac.GoNumber.reverse(): Should be overridden")}});acg.ac.goNumber=function(a,b){return new acg.ac.GoNumber(a,b)};
acg.ac.action_map={"+":cc.sequence,"//":cc.spawn,show:cc.show,hide:cc.hide,"toggle-visibility":cc.toggleVisibility,"flip-x":cc.flipX,"flip-y":cc.flipY,place:cc.place,sequence:cc.sequence,repeat:cc.repeat,persist:cc.repeatForever,spawn:cc.spawn,"rotate-to":cc.rotateTo,"rotate-by":cc.rotateBy,"move-by":cc.moveBy,"move-to":cc.moveTo,"skew-to":cc.skewTo,"skew-by":cc.skewBy,"jump-by":cc.jumpBy,"jump-to":cc.jumpTo,"bezier-at":cc.bezierAt,"bezier-by":cc.bezierBy,"bezier-to":cc.bezierTo,"scale-to":cc.scaleTo,
"scale-by":cc.scaleBy,blink:cc.blink,"fade-to":cc.fadeTo,"fade-in":cc.fadeIn,"fade-out":cc.fadeOut,"tint-to":cc.tintTo,"tint-by":cc.tintBy,delay:cc.delayTime,reverse:cc.reverseTime,"call-func":cc.callFunc,"ease-rate":cc.EaseRateAction.create,"ease-in":cc.EaseIn.create,"ease-out":cc.EaseOut.create,"ease-in-out":cc.EaseInOut.create,"ease-exponential-in":cc.EaseExponentialIn.create,"ease-exponential-out":cc.EaseExponentialOut.create,"ease-exponential-in-out":cc.EaseExponentialInOut.create,"ease-sine-in":cc.EaseSineIn.create,
"ease-sine-out":cc.EaseSineOut.create,"ease-sine-in-out":cc.EaseSineInOut.create,"ease-elastic-in":cc.EaseElasticIn.create,"ease-elastic-out":cc.EaseElasticOut.create,"ease-elastic-in-out":cc.EaseElasticInOut.create,"ease-bounce-in":cc.EaseBounceIn.create,"ease-bounce-out":cc.EaseBounceOut.create,"ease-bounce-in-out":cc.EaseBounceInOut.create,"ease-back-in":cc.EaseBackIn.create,"ease-back-out":cc.EaseBackOut.create,"ease-back-in-out":cc.EaseBackInOut.create,"ease-bezier":cc.EaseBezierAction.create,
"ease-quadratic-in":cc.EaseQuadraticActionIn.create,"ease-quadratic-out":cc.EaseQuadraticActionOut.create,"ease-quadratic-in-out":cc.EaseQuadraticActionInOut.create,"ease-quartic-in":cc.EaseQuarticActionIn.create,"ease-quartic-out":cc.EaseQuarticActionOut.create,"ease-quartic-in-out":cc.EaseQuarticActionInOut.create,"ease-quintic-in":cc.EaseQuinticActionIn.create,"ease-quintic-out":cc.EaseQuinticActionOut.create,"ease-quintic-in-out":cc.EaseQuinticActionInOut.create,"ease-circle-in":cc.EaseCircleActionIn.create,
"ease-circle-out":cc.EaseCircleActionOut.create,"ease-circle-in-out":cc.EaseCircleActionInOut.create,"ease-cubic-in":cc.EaseCubicActionIn.create,"ease-cubic-out":cc.EaseCubicActionOut.create,"ease-cubic-in-out":cc.EaseCubicActionInOut.create,"go-number":acg.ac.goNumber,"change-text":acg.ac.changeString};acg.ac.parse=function(a){if(a instanceof Array)for(var b=1;b<a.length;b++)"string"!==typeof a[b]&&"string"===typeof a[b][0]&&(a[b]=acg.ac.parse(a[b]));return acg.ac.action_map[a[0]].apply(null,a.slice(1))};acg=acg||{};acg.ext=acg.ext||{};acg.ext._words_flow=[];acg.ext._words_id=null;acg.ext._words_colour=[255,255,255];var colourEquals=function(a,b){return a[0]===b[0]&&a[1]===b[1]&&a[2]===b[2]};acg.ext.words_colour=function(a,b,c){acg.ext._words_colour=[a,b,c]};acg.ext.words=function(a,b){acg.ext._words_flow.push({time:a+acg._cur_offset,text:""===b?" ":b,colour:acg.ext._words_colour})};
acg.ext.words_commit=function(){acg.sort(acg.ext._words_flow);var a=["+",["delay",acg.ext._words_flow[0].time]];acg.ext._words_flow.push({time:acg.tot_time(),colour:[0,0,0]});for(var b=0;b<acg.ext._words_flow.length-1;b++){var c=acg.ext._words_flow[b],d=acg.ext._words_flow[b+1];a.push(["change-text",c.text]);a.push(["delay",d.time-c.time]);colourEquals(c.colour,d.colour)||a.push(["tint-to",.001,d.colour[0],d.colour[1],d.colour[2]])}acg.ext._words_id=acg.text({x:.5,y:0,ax:.5,ay:0,colour:acg.ext._words_flow[0].colour,
fontsize:26,text:" ",zorder:10012138},a);acg.put(0,acg.ext._words_id)};acg=acg||{};acg.ext=acg.ext||{};acg.ext.nametag_width=.25;acg.ext.nametag_bigfontsize=28;acg.ext.nametag_smallfontsize=18;
acg.ext.nametag=function(a,b,c,d,e){e=e||acg.colour.BLACK;e[0]&&(e=acg.colour(e[0],e[1],e[2]));var f=cc.LayerColor.create();f.setCascadeOpacityEnabled(!0);a=cc.LabelTTF.create(a,"Arial",acg.ext.nametag_bigfontsize);a.setAnchorPoint(cc.p(0,0));a.setPosition(cc.p(0,0));a.setColor(e);f.addChild(a);b=cc.LabelTTF.create(b,"Arial",acg.ext.nametag_smallfontsize);b.setAnchorPoint(cc.p(0,1));b.setPosition(cc.p(0,-1));b.setColor(e);f.addChild(b);acg.init_matter(f,{x:c,y:d,ax:0,ay:0,opacity:.001,colour:e,width:acg.ext.nametag_width,
height:1/acg.height},["+",["fade-in",.8],["delay",1.4],["fade-out",.8]]);return f._acg_id};acg=acg||{};acg.ext=acg.ext||{};acg.ext.speechbub_borderw=3;acg.ext.speechbub_horpadding=6;acg.ext.speechbub_fontsize=24;
acg.ext.speechbub=function(a,b,c,d,e,f,g,h,k){k=k||acg.colour.BLACK;k[0]&&(k=acg.colour(k[0],k[1],k[2]));var n=cc.DrawNode.create();n.setCascadeOpacityEnabled(!0);a=cc.LabelTTF.create(a,"Arial",acg.ext.speechbub_fontsize);a.setAnchorPoint(cc.p(0,0));a.setPosition(cc.p(0,0));a.setColor(k);n.addChild(a);var m=a.getContentSize();a=m.width+2*acg.ext.speechbub_horpadding;m=m.height;n.drawSegment(cc.p(a*d,m*e),cc.p(a*f,m*g),acg.ext.speechbub_borderw/2,k);n.setContentSize(cc.size(a,m));acg.init_matter(n,
{x:b,y:c,ax:d,ay:e,opacity:1},h);return n._acg_id};cc=cc||{};acg=acg||{};acg.ext=acg.ext||{};acg.ext._cp_layer=null;acg.ext._cp_ctrls=[];acg.ext._cp_ctrls_showed=!1;acg.ext._cp_swiping=!1;acg.ext._cp_swipemax=25;acg.ext._cp_shouldbepaused=null;acg.ext._cp_colourdisp_tag=12138;acg.ext._cp_danmakutypes=["danmaku-sliding.png","danmaku-stktop.png","danmaku-stkbottom.png"];acg.ext._cp_textcolours="#ffffff #ff0000 #ffff00 #00ff00 #2299ff #dd00dd #2299ff #22ff00 #000088 #ffbb00 #9900bb #55dddd #887700".split(" ");
acg.ext.is_touch_in_content=function(a,b){var c=b.getCurrentTarget().convertTouchToNodeSpace(a),d=b.getCurrentTarget().getContentSize();return!(0>c.x||c.x>d.width||0>c.y||c.y>d.height)};acg.ext.touch_swiping=function(a){return 100<cc.pDistanceSQ(a.getStartLocation(),a.getLocation())};
acg.ext.cp_playbtn=function(a){var b=cc.DrawNode.create(),c=.1*acg.height;b.setAnchorPoint(cc.p(0,0));b._cp_paused=!1;b._cp_callback=a;b.drawPlay=function(){b.clear();b.drawDot(cc.p(c,c),c,cc.color(255,255,255,128));b.drawPoly([cc.p(.7113*c,1.5*c),cc.p(.7113*c,.5*c),cc.p(1.5774*c,c)],cc.color(255,255,255,128),1,cc.color(0,0,0,255))};b.drawPause=function(){b.clear();b.drawDot(cc.p(c,c),c,cc.color(255,255,255,128));b.drawPoly([cc.p(.7113*c,1.5*c),cc.p(.7113*c,.5*c),cc.p(.8613*c,.5*c),cc.p(.8613*c,1.5*
c)],cc.color(255,255,255,128),1,cc.color(0,0,0,255));b.drawPoly([cc.p(1.2887*c,1.5*c),cc.p(1.2887*c,.5*c),cc.p(1.1387*c,.5*c),cc.p(1.1387*c,1.5*c)],cc.color(255,255,255,128),1,cc.color(0,0,0,255))};b.drawPause();b.setContentSize(cc.size(2*c,2*c));cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){return acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(a,b)},onTouchEnded:function(a,b){if(acg.ext.is_touch_in_content(a,b)){var c=b.getCurrentTarget();
c._cp_paused?c.drawPause():c.drawPlay();c._cp_paused=!c._cp_paused;c._cp_callback(c._cp_paused)}}},b);return b};
acg.ext.cp_timeline=function(a){var b=cc.DrawNode.create(),c=.72*acg.width,d=.08*acg.height,e=.012*acg.height;b.setAnchorPoint(cc.p(1,.5));b._cp_callback=a;b.drawSegment(cc.p(e,d/2),cc.p(c-e,d/2),e,cc.color(255,255,255,128));b.setContentSize(cc.size(c,d));b.setCascadeOpacityEnabled(!0);a=cc.DrawNode.create();c=.03*acg.height;a.drawDot(cc.p(0,0),c,cc.color(255,255,255,192));a.setNormalizedPosition(cc.p(.4,.5));b._cp_thumb=a;b.addChild(a);b.setProgress=function(a){this._cp_thumb.setNormalizedPositionX(a);
this._cp_callback(a)};b.getProgress=function(a){return this._cp_thumb.getNormalizedPositionX()};cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){var c=acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(a,b);c&&(this.onTouchMoved(a,b),null===acg.ext._cp_shouldbepaused&&(acg.ext._cp_shouldbepaused=acg.paused),acg.pause());return c},onTouchMoved:function(a,b){if(acg.ext.is_touch_in_content(a,b)){var c=b.getCurrentTarget(),d=c.convertTouchToNodeSpace(a).x/
c.getContentSize().width;c.setProgress(d)}},onTouchEnded:function(){acg.ext._cp_shouldbepaused||acg.resume();acg.ext._cp_shouldbepaused=null}},b);return b};acg.ext.pushArcVerts=function(a,b,c,d,e){e=(e-d)/4;for(var f=0;4>=f;f++){var g=f*e;a.push(cc.p(c*Math.cos(g+d)+b.x,c*Math.sin(g+d)+b.y))}};
acg.ext.toggle_menu=function(a,b){var c=cc.Node.create(),d=0;c.selectedIndex=function(){return d};cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){return acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(a,b)},onTouchEnded:function(c,f){acg.ext.is_touch_in_content(c,f)&&(d=(d+1)%a,b(d))}},c);return c};
acg.ext.cp_danmakuipt=function(a){var b=cc.DrawNode.create(),c=.88*acg.width;b.setAnchorPoint(cc.p(.5,1));var d=[];acg.ext.pushArcVerts(d,cc.p(4,4),4,-Math.PI/2,-Math.PI);acg.ext.pushArcVerts(d,cc.p(4,20),4,Math.PI,Math.PI/2);acg.ext.pushArcVerts(d,cc.p(c-4,20),4,Math.PI/2,0);acg.ext.pushArcVerts(d,cc.p(c-4,4),4,0,-Math.PI/2);b.drawPoly_(d,cc.color.WHITE,1,cc.color.BLACK);b.setContentSize(cc.size(c,24));var e=acg.ext._cp_danmakutypes.length,f=acg.ext.toggle_menu(e,function(a){console.log(a);for(var b=
0;b<e;b++)f.getChildByTag(b).setVisible(b===a)});f.setAnchorPoint(cc.p(0,1));f.setPosition(cc.p(0,-5));f.setContentSize(cc.size(60,45));f.setCascadeOpacityEnabled(!0);b.setCascadeOpacityEnabled(!0);b.addChild(f);for(c=0;c<e;c++)d=cc.Sprite.create(acg.ext._res_path+"/"+acg.ext._cp_danmakutypes[c]),d.setAnchorPoint(cc.p(0,0)),d.setVisible(0===c),d.setScale(.5),f.addChild(d,0,c);var g=acg.ext.toggle_menu(acg.ext._cp_textcolours.length,function(a){g.getChildByTag(acg.ext._cp_colourdisp_tag).setColor(cc.color(acg.ext._cp_textcolours[a]))});
g.setAnchorPoint(cc.p(0,1));g.setPosition(cc.p(75,-6));g.setContentSize(cc.size(60,45));g.setCascadeOpacityEnabled(!0);b.addChild(g);c=cc.LayerColor.create(cc.color(0,0,0));c.setContentSize(cc.size(54,41.5));c.setPosition(cc.p(0,3));g.addChild(c,0);c=cc.LayerColor.create(cc.color(acg.ext._cp_textcolours[0]));c.setContentSize(cc.size(46,34));c.setPosition(cc.p(4,7));g.addChild(c,1,acg.ext._cp_colourdisp_tag);cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(c,
d){var e=acg.ext._cp_ctrls_showed&&acg.ext.is_touch_in_content(c,d);if(e){var m=document.getElementById("acg_cp_danmaku"),q=document.getElementById("Cocos2dGameContainer");m.style.display="";m.style.position="absolute";m.style.top=q.offsetTop+.05*q.clientHeight+"px";m.style.left=q.offsetLeft+.06*q.clientWidth+"px";m.style.width=.88*q.clientWidth+"px";m.style["font-size"]=16/acg.height*q.clientHeight+"px";setTimeout(function(){m.focus()},10);m.onkeyup=function(c){13===c.keyCode&&(a(acg.time,f.selectedIndex(),
acg.ext._cp_textcolours[g.selectedIndex()],c.target.value),c.target.value="",b.hideInput())}}return e}},b);b.hideInput=function(){document.getElementById("acg_cp_danmaku").style.display="none"};return b};
acg.ext.cp_enable=function(a){cc.director.setDisplayStats(!1);var b=cc.Layer.create();acg.ext._cp_layer=b;acg.scene.addChild(b,100012138);var c=acg.ext.cp_playbtn(function(a){a?acg.pause():acg.resume()});acg.ext._cp_ctrls[0]=c;c.setNormalizedPosition(cc.p(.02,0));c.setOpacity(0);b.addChild(c);var d=acg.ext.cp_timeline(function(a){acg.travel(a*acg.tot_time())});acg.ext._cp_ctrls[1]=d;d.setNormalizedPosition(cc.p(.95,.08));d.setOpacity(0);b.addChild(d);var e=void 0;a&&(e=acg.ext.cp_danmakuipt(a),acg.ext._cp_ctrls[2]=
e,e.setNormalizedPosition(cc.p(.5,1)),e.setOpacity(0),b.addChild(e));acg.scene.schedule(function(){d.setProgress(acg.time/acg.tot_time());(c._cp_paused=acg.paused)?c.drawPlay():c.drawPause()},0);cc.eventManager.addListener({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:function(a,b){acg.ext._cp_swiping=!1;a._startPoint||(a._startPoint=a.getLocation());return!0},onTouchMoved:function(a,b){!acg.ext._cp_swiping&&acg.ext.touch_swiping(a)&&(acg.ext._cp_swiping=!0);if(acg.ext._cp_swiping){null===
acg.ext._cp_shouldbepaused&&(acg.ext._cp_shouldbepaused=acg.paused);acg.pause();var c=d.getProgress()+a.getDelta().x/acg.width*acg.ext._cp_swipemax/acg.tot_time();d.setProgress(0>c?0:c)}},onTouchEnded:function(a,b){!acg.ext._cp_swiping&&acg.ext._cp_ctrls_showed?(acg.ext._cp_ctrls_showed=!1,c.runAction(acg.ac.parse(["//",["move-to",.15,cc.p(.02,0)],["fade-out",.15]])),d.runAction(acg.ac.parse(["//",["move-to",.15,cc.p(.95,.08)],["fade-out",.15]])),e&&(e.runAction(acg.ac.parse(["//",["move-to",.15,
cc.p(.5,1)],["fade-out",.15]])),e.hideInput())):acg.ext._cp_swiping?(acg.ext._cp_shouldbepaused||acg.resume(),acg.ext._cp_shouldbepaused=null):(acg.ext._cp_ctrls_showed=!0,c.runAction(acg.ac.parse(["//",["move-to",.15,cc.p(.02,.02)],["fade-in",.15]])),d.runAction(acg.ac.parse(["//",["move-to",.15,cc.p(.95,.1)],["fade-in",.15]])),e&&e.runAction(acg.ac.parse(["//",["move-to",.15,cc.p(.5,.95)],["fade-in",.15]])))}},b)};acg=acg||{};acg.ext=acg.ext||{};acg.ext.sm_headsize=.2;acg.ext.sm_bodylen=.1236;acg.ext.sm_armlen=.1236;acg.ext.sm_armpos=.1;acg.ext.sm_leglen=.2;acg.ext.sm_strokew=3;
acg.ext.stickman_oneleg=function(a,b){var c=cc.DrawNode.create();c.setContentSize(cc.size(0,a/2));c.drawSegment(cc.p(0,0),cc.p(0,-a/2),acg.ext.sm_strokew,b);c.setAnchorPoint(cc.p(0,0));var d=cc.DrawNode.create();d.drawSegment(cc.p(0,0),cc.p(0,-a/2),acg.ext.sm_strokew,b);d.drawDot(cc.p(0,0),3,b);d.setAnchorPoint(cc.p(0,0));c.addChild(d);c._acg_sm_shin=d;return c};
acg.ext.stickman=function(a,b,c,d){d=d||acg.colour.BLACK;d[0]&&(d=acg.colour(d[0],d[1],d[2]));var e=acg.ext.sm_headsize*acg.height,f=acg.ext.sm_bodylen*acg.height,g=acg.ext.sm_leglen*acg.height,h=acg.ext.sm_armlen*acg.height,k=acg.ext.sm_armpos*acg.height;a.width=e/acg.width;a.height=acg.ext.sm_headsize+acg.ext.sm_bodylen+acg.ext.sm_leglen;var n=a.height*acg.height,m=cc.Layer.create();acg.init_matter(m,a,b);a=cc.DrawNode.create();a.drawDot(cc.p(0,e/2),e/2,d);acg.init_matter(a,{x:.5,y:(g+f)/n,ax:.5,
ay:0,width:1,height:e/n},c.head,m);b=cc.DrawNode.create();b.drawSegment(cc.p(e/2,0),cc.p(e/2,f),acg.ext.sm_strokew,d);b.setPosition(cc.p(0,g));m.addChild(b);e=acg.ext.stickman_oneleg(g,d);acg.init_matter(e,{x:.5,y:g/n,ax:0,ay:0},c.leg1,m);acg.init_matter(e._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["leg1-shin"],e);f=acg.ext.stickman_oneleg(g,d);acg.init_matter(f,{x:.5,y:g/n,ax:0,ay:0},c.leg2,m);acg.init_matter(f._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["leg2-shin"],f);b=acg.ext.stickman_oneleg(h,d);acg.init_matter(b,
{x:.5,y:(k+g)/n,ax:0,ay:0},c.arm1,m);acg.init_matter(b._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["arm1-shin"],b);d=acg.ext.stickman_oneleg(h,d);acg.init_matter(d,{x:.5,y:(k+g)/n,ax:0,ay:0},c.arm2,m);acg.init_matter(d._acg_sm_shin,{x:0,y:-1,ax:0,ay:0},c["arm2-shin"],d);return[m._acg_id,a._acg_id,e._acg_id,e._acg_sm_shin._acg_id,f._acg_id,f._acg_sm_shin._acg_id,b._acg_id,b._acg_sm_shin._acg_id,d._acg_id,d._acg_sm_shin._acg_id]};acg=acg||{};acg.ext=acg.ext||{};acg.ext._233_recs=[];acg.ext._233_fontname="Arial";acg.ext._233_fontsize=26;acg.ext._233_lineh=32;acg.ext._233_layer=null;acg.ext._233_firstresume=!0;acg.ext._233_onpause_reg=function(){acg.ext._233_layer.getChildren().forEach(function(a){a.pause()})};
acg.ext._233_onresume_reg=function(){if(acg.ext._233_firstresume)acg.ext._233_firstresume=!1;else{for(var a=0;2>a;a++)acg.ext._233_layer.getChildren().forEach(function(a){a.isVisible()?a.resume():a.removeFromParent(!0)});js233.reset();acg.sort(acg.ext._233_recs);acg.ext._233_recs.slice(acg.find(acg.ext._233_recs,acg.time)+1).forEach(function(a){js233.addComment.apply(null,[a.time-acg.time].concat(a.args))});a=js233.getOperations();acg.ext._233_doops(a)}};
acg.ext._233_enable=function(){acg._onpause_callbacks.push(acg.ext._233_onpause_reg);acg._onresume_callbacks.push(acg.ext._233_onresume_reg)};acg.ext._233_add=function(a,b,c,d){acg.ext._233_recs.push({time:a,args:[b,c,d]});js233.addComment(a,b,c,d)};
acg.ext._233_doops=function(a){a.forEach(function(a){switch(a.type){case js233.CMT_SLIDING:acg.ext._233_addSliding(a.line,a.text,a.time,a.duration,a.colour);break;case js233.CMT_TOP_STICKY:acg.ext._233_addSticky(1,a.line,a.text,a.time,a.duration,a.colour);break;case js233.CMT_BOTTOM_STICKY:acg.ext._233_addSticky(2,a.line,a.text,a.time,a.duration,a.colour)}})};
acg.ext._233_commit=function(){js233.setDurRange(5,10,2,3.5);acg.ext._233_layer=cc.Layer.create();acg.ext._233_layer.setLocalZOrder(2333333);acg.scene.addChild(acg.ext._233_layer);var a=js233.getOperations();acg.ext._233_doops(a)};
acg.ext._233_addSliding=function(a,b,c,d,e){e=e||acg.colour.WHITE;b=cc.LabelTTF.create(b,acg.ext._233_fontname,acg.ext._233_fontsize);b.setAnchorPoint(cc.p(0,1));b.setNormalizedPositionX(1);b.setNormalizedPositionY(1-a*acg.ext._233_lineh/acg.height);b.setColor(e);b.enableStroke(cc.color.BLACK,1);b.setVisible(!1);b.runAction(cc.sequence(cc.delayTime(c),cc.show(),cc.moveBy(d,cc.p(-(1+b.getContentSize().width/acg.width),0)),cc.removeSelf()));acg.ext._233_layer.addChild(b)};
acg.ext._233_addSticky=function(a,b,c,d,e,f){f=f||acg.colour.WHITE;c=cc.LabelTTF.create(c,acg.ext._233_fontname,acg.ext._233_fontsize);c.setLocalZOrder(2333333);if(1===a)c.setAnchorPoint(cc.p(.5,1)),c.setNormalizedPosition(cc.p(.5,1-b*acg.ext._233_lineh/acg.height));else if(2===a)c.setAnchorPoint(cc.p(.5,0)),c.setNormalizedPosition(cc.p(.5,b*acg.ext._233_lineh/acg.height));else{console.log("acg.ext._233_addSticky: Invalid type T^T");return}c.setColor(f);c.enableStroke(cc.color.BLACK,1);c.setVisible(!1);
c.runAction(cc.sequence(cc.delayTime(d),cc.show(),cc.delayTime(e),cc.removeSelf()));acg.ext._233_layer.addChild(c)};acg=acg||{};acg.ext=acg.ext||{};acg.ext._background_flow=[];acg.ext._background_id=null;acg.ext.background=function(a,b,c){acg.ext._background_flow.push({time:a+acg._cur_offset,colour:b,duration:c||.2})};
acg.ext.background_commit=function(){acg.sort(acg.ext._background_flow);var a=["+",["delay",acg.ext._background_flow[0].time]];acg.ext._background_flow.push({time:acg.tot_time()});for(var b=0;b<acg.ext._background_flow.length-1;b++){var c=acg.ext._background_flow[b],d=acg.ext._background_flow[b+1];c.time+c.duration>d.time?a.push(["tint-to",d.time-c.time,c.colour[0],c.colour[1],c.colour[2]]):(a.push(["tint-to",c.duration,c.colour[0],c.colour[1],c.colour[2]]),a.push(["delay",d.time-c.time-c.duration]))}acg.ext._background_id=
acg.rect({x:0,y:0,colour:[0,0,0]},a);acg.put(0,acg.ext._background_id)};cc=cc||{};acg=acg||{};acg.ext=acg.ext||{};acg.ext._res_path=".";acg.ext.set_res_path=function(a){a.endsWith("/")&&(a=a.substr(0,a.length-1));acg.ext._res_path=a};
